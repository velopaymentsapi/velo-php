...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.35.58-RC1/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.35.58' . PHP_EOL;
        $report .= '    SDK Package Version: 2.35.58-RC1' . PHP_EOL;
