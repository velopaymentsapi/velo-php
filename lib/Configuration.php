...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.26.124/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.26.124' . PHP_EOL;
        $report .= '    SDK Package Version: 2.26.124' . PHP_EOL;
