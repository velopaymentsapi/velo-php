...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.20.118/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.20.118' . PHP_EOL;
        $report .= '    SDK Package Version: 2.20.118' . PHP_EOL;
