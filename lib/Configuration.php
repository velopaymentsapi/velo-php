...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.18.113/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2.18.113' . PHP_EOL;
        $report .= '    SDK Package Version: 2.18.113' . PHP_EOL;
