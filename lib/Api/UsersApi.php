...
class UsersApi
{
     ...
     */
    protected function deleteUserByIdV2Request($user_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function disableUserV2Request($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $user_id The UUID of the User. (required)
     * @param  \VeloPayments\Client\Model\EmailUpdateRequest $email_update_request a new email address (required)
     *
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function emailUpdate($user_id, $email_update_request)
    {
        $this->emailUpdateWithHttpInfo($user_id, $email_update_request);
    }

    /**
     * Operation emailUpdateWithHttpInfo
     *
     * Update Email Address
     *
     * @param  string $user_id The UUID of the User. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function emailUpdateWithHttpInfo($user_id, $email_update_request)
    {
        $request = $this->emailUpdateRequest($user_id, $email_update_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function emailUpdateAsync($user_id, $email_update_request)
    {
        return $this->emailUpdateAsyncWithHttpInfo($user_id, $email_update_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation emailUpdateAsyncWithHttpInfo
     *
     * Update Email Address
     *
     * @param  string $user_id The UUID of the User. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function emailUpdateAsyncWithHttpInfo($user_id, $email_update_request)
    {
        $returnType = '';
        $request = $this->emailUpdateRequest($user_id, $email_update_request);
    ...
    /**
     * Create request for operation 'emailUpdate'
     *
     * @param  string $user_id The UUID of the User. (required)
     * @param  \VeloPayments\Client\Model\EmailUpdateRequest $email_update_request a new email address (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function emailUpdateRequest($user_id, $email_update_request)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling emailUpdate'
            );
        }
        ...
        if ($email_update_request === null || (is_array($email_update_request) && count($email_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_update_request when calling emailUpdate'
            );
        }

        $resourcePath = '/v2/users/{userId}/emailUpdate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($email_update_request)) {
            $_tempBody = $email_update_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function enableUserV2Request($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\UserResponse2|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\UserResponse2|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSelfWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\UserResponse2' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VeloPayments\Client\Model\UserResponse2', []),
            ...
            $returnType = '\VeloPayments\Client\Model\UserResponse2';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VeloPayments\Client\Model\UserResponse2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSelfRequest()
    {
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\UserResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\UserResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserByIdV2Request($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function inviteUserRequest($invite_user_request)
    {
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PagedUserResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
    public function listUsers($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        list($response) = $this->listUsersWithHttpInfo($type, $status, $entity_id, $page, $page_size, $sort);
        return $response;
    }
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PagedUserResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listUsersWithHttpInfo($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        $request = $this->listUsersRequest($type, $status, $entity_id, $page, $page_size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsersAsync($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        return $this->listUsersAsyncWithHttpInfo($type, $status, $entity_id, $page, $page_size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUsersAsyncWithHttpInfo($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        $returnType = '\VeloPayments\Client\Model\PagedUserResponse';
        $request = $this->listUsersRequest($type, $status, $entity_id, $page, $page_size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listUsersRequest($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        ...
        // query params
        if ($entity_id !== null) {
            $queryParams['entityId'] = ObjectSerializer::toQueryValue($entity_id);
        }
        // query params
        if ($page !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registerSmsRequest($register_sms_request)
    {
        ...
        if (isset($register_sms_request)) {
            $_tempBody = $register_sms_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unlockUserV2Request($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unregisterMFARequest($user_id, $unregister_mfa_request)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($unregister_mfa_request)) {
            $_tempBody = $unregister_mfa_request;
        }
     ...
     * @return void
     */
    public function unregisterMFAForSelf($self_mfa_type_unregister_request)
    {
        $this->unregisterMFAForSelfWithHttpInfo($self_mfa_type_unregister_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function unregisterMFAForSelfWithHttpInfo($self_mfa_type_unregister_request)
    {
        $request = $this->unregisterMFAForSelfRequest($self_mfa_type_unregister_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unregisterMFAForSelfAsync($self_mfa_type_unregister_request)
    {
        return $this->unregisterMFAForSelfAsyncWithHttpInfo($self_mfa_type_unregister_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function unregisterMFAForSelfAsyncWithHttpInfo($self_mfa_type_unregister_request)
    {
        $returnType = '';
        $request = $this->unregisterMFAForSelfRequest($self_mfa_type_unregister_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function unregisterMFAForSelfRequest($self_mfa_type_unregister_request)
    {
        ...
        if (isset($self_mfa_type_unregister_request)) {
            $_tempBody = $self_mfa_type_unregister_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePasswordSelfRequest($self_update_password_request)
    {
        ...
        if (isset($self_update_password_request)) {
            $_tempBody = $self_update_password_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function validatePasswordSelfRequest($password_request)
    {
