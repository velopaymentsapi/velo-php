...
class UsersApi
{
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\UserResponse2|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\UserResponse2|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\UserResponse|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\UserResponse|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function listUsersRequest($type = null, $status = null, $entity_id = null, $page = 1, $page_size = 25, $sort = 'email:asc')
    {
        ...
        // query params
        if ($entity_id !== null) {
            if('form' === 'form' && is_array($entity_id)) {
                foreach($entity_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['entityId'] = $entity_id;
            }
        }
        // query params
        if ($page !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function roleUpdateRequest($user_id, $role_update_request)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userDetailsUpdateRequest($user_id, $user_details_update_request)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($user_details_update_request)) {
            $_tempBody = $user_details_update_request;
        }
