...
class PayoutServiceApi
{
     ...
     * @return void
     */
    public function deschedulePayout($payout_id)
    {
        $this->deschedulePayoutWithHttpInfo($payout_id);
    }
     ...
     */
    public function deschedulePayoutWithHttpInfo($payout_id)
    {
        $request = $this->deschedulePayoutRequest($payout_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deschedulePayoutAsync($payout_id)
    {
        return $this->deschedulePayoutAsyncWithHttpInfo($payout_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deschedulePayoutAsyncWithHttpInfo($payout_id)
    {
        $returnType = '';
        $request = $this->deschedulePayoutRequest($payout_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deschedulePayoutRequest($payout_id)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getPaymentsForPayoutV3($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $transmission_type = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        list($response) = $this->getPaymentsForPayoutV3WithHttpInfo($payout_id, $status, $remote_id, $payor_payment_id, $source_account_name, $transmission_type, $payment_memo, $page_size, $page);
        return $response;
    }
     ...
     */
    public function getPaymentsForPayoutV3WithHttpInfo($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $transmission_type = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        $request = $this->getPaymentsForPayoutV3Request($payout_id, $status, $remote_id, $payor_payment_id, $source_account_name, $transmission_type, $payment_memo, $page_size, $page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsForPayoutV3Async($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $transmission_type = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        return $this->getPaymentsForPayoutV3AsyncWithHttpInfo($payout_id, $status, $remote_id, $payor_payment_id, $source_account_name, $transmission_type, $payment_memo, $page_size, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPaymentsForPayoutV3AsyncWithHttpInfo($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $transmission_type = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        $returnType = '\VeloPayments\Client\Model\PagedPaymentsResponseV3';
        $request = $this->getPaymentsForPayoutV3Request($payout_id, $status, $remote_id, $payor_payment_id, $source_account_name, $transmission_type, $payment_memo, $page_size, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPaymentsForPayoutV3Request($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $transmission_type = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $payout_id Id of the payout (required)
     * @param  \VeloPayments\Client\Model\InstructPayoutRequest $instruct_payout_request Additional instruct payout parameters (optional)
     *
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function instructPayoutV3($payout_id, $instruct_payout_request = null)
    {
        $this->instructPayoutV3WithHttpInfo($payout_id, $instruct_payout_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function instructPayoutV3WithHttpInfo($payout_id, $instruct_payout_request = null)
    {
        $request = $this->instructPayoutV3Request($payout_id, $instruct_payout_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function instructPayoutV3Async($payout_id, $instruct_payout_request = null)
    {
        return $this->instructPayoutV3AsyncWithHttpInfo($payout_id, $instruct_payout_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function instructPayoutV3AsyncWithHttpInfo($payout_id, $instruct_payout_request = null)
    {
        $returnType = '';
        $request = $this->instructPayoutV3Request($payout_id, $instruct_payout_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function instructPayoutV3Request($payout_id, $instruct_payout_request = null)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($instruct_payout_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($instruct_payout_request));
            } else {
                $httpBody = $instruct_payout_request;
            }
     ...
     *
     * @param  string $payout_id Id of the payout (required)
     * @param  \VeloPayments\Client\Model\SchedulePayoutRequest $schedule_payout_request schedule payout parameters (optional)
     *
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function scheduleForPayout($payout_id, $schedule_payout_request = null)
    {
        $this->scheduleForPayoutWithHttpInfo($payout_id, $schedule_payout_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function scheduleForPayoutWithHttpInfo($payout_id, $schedule_payout_request = null)
    {
        $request = $this->scheduleForPayoutRequest($payout_id, $schedule_payout_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function scheduleForPayoutAsync($payout_id, $schedule_payout_request = null)
    {
        return $this->scheduleForPayoutAsyncWithHttpInfo($payout_id, $schedule_payout_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function scheduleForPayoutAsyncWithHttpInfo($payout_id, $schedule_payout_request = null)
    {
        $returnType = '';
        $request = $this->scheduleForPayoutRequest($payout_id, $schedule_payout_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function scheduleForPayoutRequest($payout_id, $schedule_payout_request = null)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($schedule_payout_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($schedule_payout_request));
            } else {
                $httpBody = $schedule_payout_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
