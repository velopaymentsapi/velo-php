...
class PayoutServiceApi
{
     ...
     */
    protected function createQuoteForPayoutV3Request($payout_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPaymentsForPayoutV3Request($payout_id, $status = null, $remote_id = null, $payor_payment_id = null, $source_account_name = null, $payment_memo = null, $page_size = 25, $page = 1)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutSummaryV3Request($payout_id)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function instructPayoutV3Request($payout_id)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function submitPayoutV3Request($create_payout_request_v3)
    {
        ...
        if (isset($create_payout_request_v3)) {
            $_tempBody = $create_payout_request_v3;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function withdrawPaymentRequest($payment_id, $withdraw_payment_request)
    {
        ...
        if (isset($withdraw_payment_request)) {
            $_tempBody = $withdraw_payment_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function withdrawPayoutV3Request($payout_id)
    {
        // verify the required parameter 'payout_id' is set
        if ($payout_id === null || (is_array($payout_id) && count($payout_id) === 0)) {
            throw new \InvalidArgumentException(
