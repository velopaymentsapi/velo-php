...
class AuthApi
{
     ...
     *
     * @param  string $authorization String value of Basic and a Base64 endcoded string comprising the API key (e.g. 44a9537d-d55d-4b47-8082-14061c2bcdd8) and API secret  (e.g. c396b26b-137a-44fd-87f5-34631f8fd529) with a colon between them.  E.g. Basic 44a9537d-d55d-4b47-8082-14061c2bcdd8:c396b26b-137a-44fd-87f5-34631f8fd529 (required)
     ...
     */
    public function veloAuth($authorization, $grant_type = 'client_credentials')
    {
        list($response) = $this->veloAuthWithHttpInfo($authorization, $grant_type);
        return $response;
    }
     ...
     */
    public function veloAuthWithHttpInfo($authorization, $grant_type = 'client_credentials')
    {
        $request = $this->veloAuthRequest($authorization, $grant_type);
     ...
     */
    public function veloAuthAsync($authorization, $grant_type = 'client_credentials')
    {
        return $this->veloAuthAsyncWithHttpInfo($authorization, $grant_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function veloAuthAsyncWithHttpInfo($authorization, $grant_type = 'client_credentials')
    {
        $returnType = '\VeloPayments\Client\Model\AuthResponse';
        $request = $this->veloAuthRequest($authorization, $grant_type);
     ...
     */
    protected function veloAuthRequest($authorization, $grant_type = 'client_credentials')
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling veloAuth'
            );
        }
