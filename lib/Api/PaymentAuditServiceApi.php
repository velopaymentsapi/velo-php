...
class PaymentAuditServiceApi
{
     ...
     */
    public function getPayoutsForPayorV4($payor_id = null, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $from_payor_name = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null)
    {
        list($response) = $this->getPayoutsForPayorV4WithHttpInfo($payor_id, $payout_memo, $status, $submitted_date_from, $submitted_date_to, $from_payor_name, $scheduled_for_date_from, $scheduled_for_date_to, $schedule_status, $page, $page_size, $sort);
        return $response;
    }
     ...
     */
    public function getPayoutsForPayorV4WithHttpInfo($payor_id = null, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $from_payor_name = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null)
    {
        $request = $this->getPayoutsForPayorV4Request($payor_id, $payout_memo, $status, $submitted_date_from, $submitted_date_to, $from_payor_name, $scheduled_for_date_from, $scheduled_for_date_to, $schedule_status, $page, $page_size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayoutsForPayorV4Async($payor_id = null, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $from_payor_name = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null)
    {
        return $this->getPayoutsForPayorV4AsyncWithHttpInfo($payor_id, $payout_memo, $status, $submitted_date_from, $submitted_date_to, $from_payor_name, $scheduled_for_date_from, $scheduled_for_date_to, $schedule_status, $page, $page_size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPayoutsForPayorV4AsyncWithHttpInfo($payor_id = null, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $from_payor_name = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null)
    {
        $returnType = '\VeloPayments\Client\Model\GetPayoutsResponse';
        $request = $this->getPayoutsForPayorV4Request($payor_id, $payout_memo, $status, $submitted_date_from, $submitted_date_to, $from_payor_name, $scheduled_for_date_from, $scheduled_for_date_to, $schedule_status, $page, $page_size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPayoutsForPayorV4Request($payor_id = null, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $from_payor_name = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null)
    {
        if ($page_size !== null && $page_size > 100) {
        ...
        // query params
        if ($scheduled_for_date_from !== null) {
            if('form' === 'form' && is_array($scheduled_for_date_from)) {
                foreach($scheduled_for_date_from as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['scheduledForDateFrom'] = $scheduled_for_date_from;
            }
        }
        // query params
        if ($scheduled_for_date_to !== null) {
            if('form' === 'form' && is_array($scheduled_for_date_to)) {
                foreach($scheduled_for_date_to as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['scheduledForDateTo'] = $scheduled_for_date_to;
            }
        }
        // query params
        if ($schedule_status !== null) {
            if('form' === 'form' && is_array($schedule_status)) {
                foreach($schedule_status as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['scheduleStatus'] = $schedule_status;
            }
        }
        // query params
        if ($page !== null) {
     ...
     */
    public function listPaymentsAuditV4($payee_id = null, $payor_id = null, $payor_name = null, $remote_id = null, $remote_system_id = null, $status = null, $transmission_type = null, $source_account_name = null, $source_amount_from = null, $source_amount_to = null, $source_currency = null, $payment_amount_from = null, $payment_amount_to = null, $payment_currency = null, $submitted_date_from = null, $submitted_date_to = null, $payment_memo = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
     ...
     */
    public function listPaymentsAuditV4WithHttpInfo($payee_id = null, $payor_id = null, $payor_name = null, $remote_id = null, $remote_system_id = null, $status = null, $transmission_type = null, $source_account_name = null, $source_amount_from = null, $source_amount_to = null, $source_currency = null, $payment_amount_from = null, $payment_amount_to = null, $payment_currency = null, $submitted_date_from = null, $submitted_date_to = null, $payment_memo = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentsAuditV4Async($payee_id = null, $payor_id = null, $payor_name = null, $remote_id = null, $remote_system_id = null, $status = null, $transmission_type = null, $source_account_name = null, $source_amount_from = null, $source_amount_to = null, $source_currency = null, $payment_amount_from = null, $payment_amount_to = null, $payment_currency = null, $submitted_date_from = null, $submitted_date_to = null, $payment_memo = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentsAuditV4AsyncWithHttpInfo($payee_id = null, $payor_id = null, $payor_name = null, $remote_id = null, $remote_system_id = null, $status = null, $transmission_type = null, $source_account_name = null, $source_amount_from = null, $source_amount_to = null, $source_currency = null, $payment_amount_from = null, $payment_amount_to = null, $payment_currency = null, $submitted_date_from = null, $submitted_date_to = null, $payment_memo = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
        $returnType = '\VeloPayments\Client\Model\ListPaymentsResponseV4';
        $request = $this->listPaymentsAuditV4Request($payee_id, $payor_id, $payor_name, $remote_id, $remote_system_id, $status, $transmission_type, $source_account_name, $source_amount_from, $source_amount_to, $source_currency, $payment_amount_from, $payment_amount_to, $payment_currency, $submitted_date_from, $submitted_date_to, $payment_memo, $scheduled_for_date_from, $scheduled_for_date_to, $schedule_status, $page, $page_size, $sort, $sensitive);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listPaymentsAuditV4Request($payee_id = null, $payor_id = null, $payor_name = null, $remote_id = null, $remote_system_id = null, $status = null, $transmission_type = null, $source_account_name = null, $source_amount_from = null, $source_amount_to = null, $source_currency = null, $payment_amount_from = null, $payment_amount_to = null, $payment_currency = null, $submitted_date_from = null, $submitted_date_to = null, $payment_memo = null, $scheduled_for_date_from = null, $scheduled_for_date_to = null, $schedule_status = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
        if ($page_size !== null && $page_size > 100) {
