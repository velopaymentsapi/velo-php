...
class PaymentAuditServiceApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function exportTransactionsCSVV4Request($payor_id = null, $start_date = null, $end_date = null, $include = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFundingsV1Request($payor_id, $page = 1, $page_size = 25, $sort = null)
    {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getFundingsV1, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getFundingsV1, must be bigger than or equal to 1.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFundingsV4Request($payor_id, $page = 1, $page_size = 25, $sort = null)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function getPaymentsForPayoutRequest($payout_id, $remote_id = null, $status = null, $source_amount_from = null, $source_amount_to = null, $payment_amount_from = null, $payment_amount_to = null, $submitted_date_from = null, $submitted_date_to = null, $page = 1, $page_size = 25, $sort = null, $sensitive = null)
    {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getPaymentsForPayout, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getPaymentsForPayout, must be bigger than or equal to 1.');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayoutStatsV4Request($payor_id = null)
    {
    ...
    protected function getPayoutsForPayorV3Request($payor_id, $payout_memo = null, $status = null, $submitted_date_from = null, $submitted_date_to = null, $page = 1, $page_size = 25, $sort = null)
    {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getPayoutsForPayorV3, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.getPayoutsForPayorV3, must be bigger than or equal to 1.');
        }
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\GetPayoutsResponseV4|\VeloPayments\Client\Model\InlineResponse400|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403|\VeloPayments\Client\Model\InlineResponse404
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\GetPayoutsResponseV4|\VeloPayments\Client\Model\InlineResponse400|\VeloPayments\Client\Model\InlineResponse401|\VeloPayments\Client\Model\InlineResponse403|\VeloPayments\Client\Model\InlineResponse404, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    protected function listPaymentChangesRequest($payor_id, $updated_since, $page = 1, $page_size = 100)
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.listPaymentChanges, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.listPaymentChanges, must be bigger than or equal to 1.');
        }
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PaymentDeltaResponseV4
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PaymentDeltaResponseV4, HTTP status code, HTTP response headers (array of strings)
     */
    public function listPaymentChangesV4WithHttpInfo($payor_id, $updated_since, $page = 1, $page_size = 100)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\PaymentDeltaResponseV4' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VeloPayments\Client\Model\PaymentDeltaResponseV4', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\VeloPayments\Client\Model\PaymentDeltaResponseV4';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VeloPayments\Client\Model\PaymentDeltaResponseV4',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listPaymentChangesV4Request($payor_id, $updated_since, $page = 1, $page_size = 100)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.listPaymentsAudit, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling PaymentAuditServiceApi.listPaymentsAudit, must be bigger than or equal to 1.');
        }
