...
class PayeeInvitationApi
{
     ...
     * @deprecated
     */
    public function createPayeeV3($create_payees_request_v3 = null)
    {
        list($response) = $this->createPayeeV3WithHttpInfo($create_payees_request_v3);
        return $response;
    }
     ...
     * @deprecated
     */
    public function createPayeeV3WithHttpInfo($create_payees_request_v3 = null)
    {
        $request = $this->createPayeeV3Request($create_payees_request_v3);
     ...
     * @deprecated
     */
    public function createPayeeV3Async($create_payees_request_v3 = null)
    {
        return $this->createPayeeV3AsyncWithHttpInfo($create_payees_request_v3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createPayeeV3AsyncWithHttpInfo($create_payees_request_v3 = null)
    {
        $returnType = '\VeloPayments\Client\Model\CreatePayeesCSVResponseV3';
        $request = $this->createPayeeV3Request($create_payees_request_v3);
     ...
     * @deprecated
     */
    public function createPayeeV3Request($create_payees_request_v3 = null)
    {
        ...
        if (isset($create_payees_request_v3)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_payees_request_v3));
            } else {
     ...
     * @param  \VeloPayments\Client\Model\InvitationStatusV4 $invitation_status The invitation status of the payees. (optional)
    ...
    public function getPayeesInvitationStatusV3Request($payor_id, $payee_id = null, $invitation_status = null, $page = 1, $page_size = 25)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'InvitationStatusV4', // openApiType
            'form', // style
            true // explode
        ) ?? []);
        // query params
     ...
     * @deprecated
     */
    public function resendPayeeInviteV3($payee_id, $invite_payee_request_v3)
    {
        $this->resendPayeeInviteV3WithHttpInfo($payee_id, $invite_payee_request_v3);
    }
     ...
     * @deprecated
     */
    public function resendPayeeInviteV3WithHttpInfo($payee_id, $invite_payee_request_v3)
    {
        $request = $this->resendPayeeInviteV3Request($payee_id, $invite_payee_request_v3);
     ...
     * @deprecated
     */
    public function resendPayeeInviteV3Async($payee_id, $invite_payee_request_v3)
    {
        return $this->resendPayeeInviteV3AsyncWithHttpInfo($payee_id, $invite_payee_request_v3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function resendPayeeInviteV3AsyncWithHttpInfo($payee_id, $invite_payee_request_v3)
    {
        $returnType = '';
        $request = $this->resendPayeeInviteV3Request($payee_id, $invite_payee_request_v3);
     ...
     * @deprecated
     */
    public function resendPayeeInviteV3Request($payee_id, $invite_payee_request_v3)
    {
        ...
        if (isset($invite_payee_request_v3)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($invite_payee_request_v3));
            } else {
     ...
     * @return void
     */
    public function resendPayeeInviteV4($payee_id, $invite_payee_request_v4)
    {
        $this->resendPayeeInviteV4WithHttpInfo($payee_id, $invite_payee_request_v4);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function resendPayeeInviteV4WithHttpInfo($payee_id, $invite_payee_request_v4)
    {
        $request = $this->resendPayeeInviteV4Request($payee_id, $invite_payee_request_v4);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resendPayeeInviteV4Async($payee_id, $invite_payee_request_v4)
    {
        return $this->resendPayeeInviteV4AsyncWithHttpInfo($payee_id, $invite_payee_request_v4)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resendPayeeInviteV4AsyncWithHttpInfo($payee_id, $invite_payee_request_v4)
    {
        $returnType = '';
        $request = $this->resendPayeeInviteV4Request($payee_id, $invite_payee_request_v4);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resendPayeeInviteV4Request($payee_id, $invite_payee_request_v4)
    {
        // verify the required parameter 'payee_id' is set
        if ($payee_id === null || (is_array($payee_id) && count($payee_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($invite_payee_request_v4)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($invite_payee_request_v4));
            } else {
     ...
     */
    public function v4CreatePayee($create_payees_request_v4 = null)
    {
        list($response) = $this->v4CreatePayeeWithHttpInfo($create_payees_request_v4);
        return $response;
    }
     ...
     */
    public function v4CreatePayeeWithHttpInfo($create_payees_request_v4 = null)
    {
        $request = $this->v4CreatePayeeRequest($create_payees_request_v4);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v4CreatePayeeAsync($create_payees_request_v4 = null)
    {
        return $this->v4CreatePayeeAsyncWithHttpInfo($create_payees_request_v4)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v4CreatePayeeAsyncWithHttpInfo($create_payees_request_v4 = null)
    {
        $returnType = '\VeloPayments\Client\Model\CreatePayeesCSVResponseV4';
        $request = $this->v4CreatePayeeRequest($create_payees_request_v4);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v4CreatePayeeRequest($create_payees_request_v4 = null)
    {
        ...
        if (isset($create_payees_request_v4)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_payees_request_v4));
            } else {
