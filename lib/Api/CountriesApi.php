...
class CountriesApi
{
    ...
    {
        list($response) = $this->listPaymentChannelRulesV1WithHttpInfo();
        return $response;
    }
     ...
     */
    public function listPaymentChannelRulesV1WithHttpInfo()
    {
        $request = $this->listPaymentChannelRulesV1Request();
     ...
     */
    public function listPaymentChannelRulesV1Async()
    {
        return $this->listPaymentChannelRulesV1AsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listPaymentChannelRulesV1AsyncWithHttpInfo()
    {
        $returnType = '\VeloPayments\Client\Model\PaymentChannelRulesResponse';
        $request = $this->listPaymentChannelRulesV1Request();
     ...
     */
    protected function listPaymentChannelRulesV1Request()
    {
    ...
    {
        list($response) = $this->listSupportedCountriesV2WithHttpInfo();
        return $response;
    }
     ...
     */
    public function listSupportedCountriesV2WithHttpInfo()
    {
        $request = $this->listSupportedCountriesV2Request();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSupportedCountriesV2Async()
    {
        return $this->listSupportedCountriesV2AsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSupportedCountriesV2AsyncWithHttpInfo()
    {
        $returnType = '\VeloPayments\Client\Model\SupportedCountriesResponseV2';
        $request = $this->listSupportedCountriesV2Request();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listSupportedCountriesV2Request()
    {
