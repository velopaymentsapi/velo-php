...
/**
 * PayorHierarchyApi Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
...
class PayorHierarchyApi
{
    ...
    /**
     * Operation payorLinksV1
     *
     * List Payor Links
     *
     * @param  string $descendants_of_payor The Payor ID from which to start the query to show all descendants (optional)
     * @param  string $parent_of_payor Query for the parent payor details for this payor id (optional)
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['payorLinksV1'] to see the possible values for this operation
     *
     ...
     */
    public function payorLinksV1($descendants_of_payor = null, $parent_of_payor = null, $fields = null, string $contentType = self::contentTypes['payorLinksV1'][0])
    {
        list($response) = $this->payorLinksV1WithHttpInfo($descendants_of_payor, $parent_of_payor, $fields, $contentType);
        return $response;
    }

    /**
     * Operation payorLinksV1WithHttpInfo
     *
     * List Payor Links
     *
     * @param  string $descendants_of_payor The Payor ID from which to start the query to show all descendants (optional)
     ...
     */
    public function payorLinksV1WithHttpInfo($descendants_of_payor = null, $parent_of_payor = null, $fields = null, string $contentType = self::contentTypes['payorLinksV1'][0])
    {
        $request = $this->payorLinksV1Request($descendants_of_payor, $parent_of_payor, $fields, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\PayorLinksResponse' === '\SplFileObject') {
                        ...
                        if ('\VeloPayments\Client\Model\PayorLinksResponse' !== 'string') {
                            try {
     ...
     */
    public function payorLinksV1Async($descendants_of_payor = null, $parent_of_payor = null, $fields = null, string $contentType = self::contentTypes['payorLinksV1'][0])
    {
        return $this->payorLinksV1AsyncWithHttpInfo($descendants_of_payor, $parent_of_payor, $fields, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation payorLinksV1AsyncWithHttpInfo
     *
     * List Payor Links
     *
     * @param  string $descendants_of_payor The Payor ID from which to start the query to show all descendants (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payorLinksV1AsyncWithHttpInfo($descendants_of_payor = null, $parent_of_payor = null, $fields = null, string $contentType = self::contentTypes['payorLinksV1'][0])
    {
        $returnType = '\VeloPayments\Client\Model\PayorLinksResponse';
        $request = $this->payorLinksV1Request($descendants_of_payor, $parent_of_payor, $fields, $contentType);
    ...
    /**
     * Create request for operation 'payorLinksV1'
     *
     * @param  string $descendants_of_payor The Payor ID from which to start the query to show all descendants (optional)
     * @param  string $parent_of_payor Query for the parent payor details for this payor id (optional)
     * @param  string $fields &lt;p&gt;List of additional Payor fields to include in the response for each Payor&lt;/p&gt; &lt;p&gt;The values of payorId and payorName are always included for each Payor by default&lt;/p&gt; &lt;p&gt;You can add fields to the response for each payor by including them in the fields parameter separated by commas&lt;/p&gt; &lt;p&gt;The supported fields are any combination of: primaryContactEmail,kycState&lt;/p&gt; (optional)
     ...
     */
    public function payorLinksV1Request($descendants_of_payor = null, $parent_of_payor = null, $fields = null, string $contentType = self::contentTypes['payorLinksV1'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'descendantsOfPayor', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
