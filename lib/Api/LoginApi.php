...
class LoginApi
{
    ...
    public function resetPasswordRequest($reset_password_request)
    {
        ...
        if (isset($reset_password_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($reset_password_request));
            } else {
     ...
     */
    public function validateAccessToken($access_token_validation_request, $authorization = null)
    {
        list($response) = $this->validateAccessTokenWithHttpInfo($access_token_validation_request, $authorization);
        return $response;
    }
     ...
     */
    public function validateAccessTokenWithHttpInfo($access_token_validation_request, $authorization = null)
    {
        $request = $this->validateAccessTokenRequest($access_token_validation_request, $authorization);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateAccessTokenAsync($access_token_validation_request, $authorization = null)
    {
        return $this->validateAccessTokenAsyncWithHttpInfo($access_token_validation_request, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateAccessTokenAsyncWithHttpInfo($access_token_validation_request, $authorization = null)
    {
        $returnType = '\VeloPayments\Client\Model\AccessTokenResponse';
        $request = $this->validateAccessTokenRequest($access_token_validation_request, $authorization);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validateAccessTokenRequest($access_token_validation_request, $authorization = null)
    {
        ...
        if (isset($access_token_validation_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($access_token_validation_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function veloAuthRequest($grant_type = 'client_credentials')
    {
