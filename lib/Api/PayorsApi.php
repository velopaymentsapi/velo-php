...
class PayorsApi
{
     ...
     * @return \VeloPayments\Client\Model\PayorV1|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorV1|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorV2|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorV2|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPayorByIdV2Request($payor_id)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payorAddPayorLogoRequest($payor_id, $logo = null)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorCreateApiKeyResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorCreateApiKeyResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payorEmailOptOutRequest($payor_id, $payor_email_opt_out_request)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($payor_email_opt_out_request)) {
            $_tempBody = $payor_email_opt_out_request;
        }
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorBrandingResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorBrandingResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payorGetBrandingRequest($payor_id)
    {
        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorLinksResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorLinksResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse|\VeloPayments\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payorLinksRequest($descendants_of_payor = null, $parent_of_payor = null, $fields = null)
    {
        ...
        if ($descendants_of_payor !== null) {
            $queryParams['descendantsOfPayor'] = ObjectSerializer::toQueryValue($descendants_of_payor);
        }
        // query params
        if ($parent_of_payor !== null) {
            $queryParams['parentOfPayor'] = ObjectSerializer::toQueryValue($parent_of_payor);
        }
        // query params
        if ($fields !== null) {
