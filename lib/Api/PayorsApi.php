...
/**
    ...
    /**
     * Operation getPayorByIdV1
     *
     * Get Payor
     *
     * @param  string $payor_id The Payor Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPayorByIdV1'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function getPayorByIdV1($payor_id, string $contentType = self::contentTypes['getPayorByIdV1'][0])
    {
        list($response) = $this->getPayorByIdV1WithHttpInfo($payor_id, $contentType);
        return $response;
    }

    /**
     * Operation getPayorByIdV1WithHttpInfo
     *
     * Get Payor
     *
     * @param  string $payor_id The Payor Id (required)
     ...
     * @deprecated
     */
    public function getPayorByIdV1WithHttpInfo($payor_id, string $contentType = self::contentTypes['getPayorByIdV1'][0])
    {
        $request = $this->getPayorByIdV1Request($payor_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\PayorV1' === '\SplFileObject') {
                        ...
                        if ('\VeloPayments\Client\Model\PayorV1' !== 'string') {
     ...
     * @deprecated
     */
    public function getPayorByIdV1Async($payor_id, string $contentType = self::contentTypes['getPayorByIdV1'][0])
    {
        return $this->getPayorByIdV1AsyncWithHttpInfo($payor_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getPayorByIdV1AsyncWithHttpInfo
     *
     * Get Payor
     *
     * @param  string $payor_id The Payor Id (required)
     ...
     * @deprecated
     */
    public function getPayorByIdV1AsyncWithHttpInfo($payor_id, string $contentType = self::contentTypes['getPayorByIdV1'][0])
    {
        $returnType = '\VeloPayments\Client\Model\PayorV1';
        $request = $this->getPayorByIdV1Request($payor_id, $contentType);
    ...
    /**
     * Create request for operation 'getPayorByIdV1'
     *
     * @param  string $payor_id The Payor Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getPayorByIdV1'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function getPayorByIdV1Request($payor_id, string $contentType = self::contentTypes['getPayorByIdV1'][0])
    {

        // verify the required parameter 'payor_id' is set
        if ($payor_id === null || (is_array($payor_id) && count($payor_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payor_id when calling getPayorByIdV1'
            );
        }
