...
class PayorsApi
{
     ...
     * @return \VeloPayments\Client\Model\PayorV1
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorV1, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorV2
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorV2, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorBrandingResponse
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorBrandingResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * List Payor Links
     *
     * @param  string $descendants_of_payor The Payor ID from which to start the query to show all descendants (required)
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayorLinksResponse
     */
    public function payorLinks($descendants_of_payor, $fields = null)
    {
        list($response) = $this->payorLinksWithHttpInfo($descendants_of_payor, $fields);
        return $response;
    }
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayorLinksResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payorLinksWithHttpInfo($descendants_of_payor, $fields = null)
    {
        $request = $this->payorLinksRequest($descendants_of_payor, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payorLinksAsync($descendants_of_payor, $fields = null)
    {
        return $this->payorLinksAsyncWithHttpInfo($descendants_of_payor, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payorLinksAsyncWithHttpInfo($descendants_of_payor, $fields = null)
    {
        $returnType = '\VeloPayments\Client\Model\PayorLinksResponse';
        $request = $this->payorLinksRequest($descendants_of_payor, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payorLinksRequest($descendants_of_payor, $fields = null)
    {
        // verify the required parameter 'descendants_of_payor' is set
        if ($descendants_of_payor === null || (is_array($descendants_of_payor) && count($descendants_of_payor) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $descendants_of_payor when calling payorLinks'
            );
        }
