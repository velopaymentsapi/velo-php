...
class PayorsApi
{
     ...
     * @return \VeloPayments\Client\Model\Payor
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\Payor, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPayorByIdWithHttpInfo($payor_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\Payor' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\VeloPayments\Client\Model\Payor', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\VeloPayments\Client\Model\Payor';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\VeloPayments\Client\Model\Payor',
     ...
     *
     * @param  string $payor_id The account owner Payor ID (required)
     * @param  \VeloPayments\Client\Model\PayorEmailOptOutRequest $payor_email_opt_out_request Details of application API key to create (required)
     *
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
