...
class PayeesApi
{
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayeeDetailResponseV3
     * @deprecated
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayeeDetailResponseV3, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayeeDetailResponseV4
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayeeDetailResponseV4, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayeeDeltaResponseV3
     * @deprecated
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayeeDeltaResponseV3, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \VeloPayments\Client\Model\PayeeDeltaResponseV4
     */
     ...
     * @throws \VeloPayments\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \VeloPayments\Client\Model\PayeeDeltaResponseV4, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \VeloPayments\Client\Model\WatchlistStatusV3 $watchlist_status The watchlistStatus of the payees. (optional)
     * @param  bool $disabled Payee disabled (optional)
     * @param  \VeloPayments\Client\Model\OnboardedStatusV4 $onboarded_status The onboarded status of the payees. (optional)
     ...
     * @param  \VeloPayments\Client\Model\PayeeType2 $payee_type The onboarded status of the payees. (optional)
     * @param  string $payee_country The country of the payee - 2 letter ISO 3166-1 country code (upper case) (optional)
     * @param  \VeloPayments\Client\Model\OfacStatusV4 $ofac_status The ofacStatus of the payees. (optional)
     * @param  int $page Page number. Default is 1. (optional, default to 1)
     * @param  int $page_size Page size. Default is 25. Max allowable is 100. (optional, default to 25)
     * @param  string $sort List of sort fields (e.g. ?sort&#x3D;onboardedStatus:asc,name:asc) Default is name:asc &#39;name&#39; is treated as company name for companies - last name + &#39;,&#39; + firstName for individuals The supported sort fields are - payeeId, displayName, payoutStatus, onboardedStatus. (optional, default to 'displayName:asc')
     *
     ...
     * @deprecated
     */
    public function payeeDetailsUpdateV3($payee_id, $update_payee_details_request_v3)
    {
        $this->payeeDetailsUpdateV3WithHttpInfo($payee_id, $update_payee_details_request_v3);
    }
     ...
     * @deprecated
     */
    public function payeeDetailsUpdateV3WithHttpInfo($payee_id, $update_payee_details_request_v3)
    {
        $request = $this->payeeDetailsUpdateV3Request($payee_id, $update_payee_details_request_v3);
     ...
     * @deprecated
     */
    public function payeeDetailsUpdateV3Async($payee_id, $update_payee_details_request_v3)
    {
        return $this->payeeDetailsUpdateV3AsyncWithHttpInfo($payee_id, $update_payee_details_request_v3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function payeeDetailsUpdateV3AsyncWithHttpInfo($payee_id, $update_payee_details_request_v3)
    {
        $returnType = '';
        $request = $this->payeeDetailsUpdateV3Request($payee_id, $update_payee_details_request_v3);
     ...
     * @deprecated
     */
    public function payeeDetailsUpdateV3Request($payee_id, $update_payee_details_request_v3)
    {
        // verify the required parameter 'payee_id' is set
        if ($payee_id === null || (is_array($payee_id) && count($payee_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_payee_details_request_v3)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_payee_details_request_v3));
            } else {
     ...
     * @return void
     */
    public function payeeDetailsUpdateV4($payee_id, $update_payee_details_request_v4)
    {
        $this->payeeDetailsUpdateV4WithHttpInfo($payee_id, $update_payee_details_request_v4);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function payeeDetailsUpdateV4WithHttpInfo($payee_id, $update_payee_details_request_v4)
    {
        $request = $this->payeeDetailsUpdateV4Request($payee_id, $update_payee_details_request_v4);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payeeDetailsUpdateV4Async($payee_id, $update_payee_details_request_v4)
    {
        return $this->payeeDetailsUpdateV4AsyncWithHttpInfo($payee_id, $update_payee_details_request_v4)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payeeDetailsUpdateV4AsyncWithHttpInfo($payee_id, $update_payee_details_request_v4)
    {
        $returnType = '';
        $request = $this->payeeDetailsUpdateV4Request($payee_id, $update_payee_details_request_v4);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function payeeDetailsUpdateV4Request($payee_id, $update_payee_details_request_v4)
    {
        // verify the required parameter 'payee_id' is set
        if ($payee_id === null || (is_array($payee_id) && count($payee_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_payee_details_request_v4)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_payee_details_request_v4));
            } else {
     ...
     * @deprecated
     */
    public function v3PayeesPayeeIdRemoteIdUpdatePost($payee_id, $update_remote_id_request_v3)
    {
        $this->v3PayeesPayeeIdRemoteIdUpdatePostWithHttpInfo($payee_id, $update_remote_id_request_v3);
    }
     ...
     * @deprecated
     */
    public function v3PayeesPayeeIdRemoteIdUpdatePostWithHttpInfo($payee_id, $update_remote_id_request_v3)
    {
        $request = $this->v3PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v3);
     ...
     * @deprecated
     */
    public function v3PayeesPayeeIdRemoteIdUpdatePostAsync($payee_id, $update_remote_id_request_v3)
    {
        return $this->v3PayeesPayeeIdRemoteIdUpdatePostAsyncWithHttpInfo($payee_id, $update_remote_id_request_v3)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function v3PayeesPayeeIdRemoteIdUpdatePostAsyncWithHttpInfo($payee_id, $update_remote_id_request_v3)
    {
        $returnType = '';
        $request = $this->v3PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v3);
     ...
     * @deprecated
     */
    public function v3PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v3)
    {
        // verify the required parameter 'payee_id' is set
        if ($payee_id === null || (is_array($payee_id) && count($payee_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_remote_id_request_v3)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_remote_id_request_v3));
            } else {
     ...
     * @return void
     */
    public function v4PayeesPayeeIdRemoteIdUpdatePost($payee_id, $update_remote_id_request_v4)
    {
        $this->v4PayeesPayeeIdRemoteIdUpdatePostWithHttpInfo($payee_id, $update_remote_id_request_v4);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function v4PayeesPayeeIdRemoteIdUpdatePostWithHttpInfo($payee_id, $update_remote_id_request_v4)
    {
        $request = $this->v4PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v4);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v4PayeesPayeeIdRemoteIdUpdatePostAsync($payee_id, $update_remote_id_request_v4)
    {
        return $this->v4PayeesPayeeIdRemoteIdUpdatePostAsyncWithHttpInfo($payee_id, $update_remote_id_request_v4)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v4PayeesPayeeIdRemoteIdUpdatePostAsyncWithHttpInfo($payee_id, $update_remote_id_request_v4)
    {
        $returnType = '';
        $request = $this->v4PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v4);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v4PayeesPayeeIdRemoteIdUpdatePostRequest($payee_id, $update_remote_id_request_v4)
    {
        // verify the required parameter 'payee_id' is set
        if ($payee_id === null || (is_array($payee_id) && count($payee_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($update_remote_id_request_v4)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_remote_id_request_v4));
            } else {
