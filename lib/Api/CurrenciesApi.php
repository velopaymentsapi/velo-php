...
class CurrenciesApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listSupportedCurrenciesV2'] to see the possible values for this operation
     *
     ...
     */
    public function listSupportedCurrenciesV2(string $contentType = self::contentTypes['listSupportedCurrenciesV2'][0])
    {
        list($response) = $this->listSupportedCurrenciesV2WithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function listSupportedCurrenciesV2WithHttpInfo(string $contentType = self::contentTypes['listSupportedCurrenciesV2'][0])
    {
        $request = $this->listSupportedCurrenciesV2Request($contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\VeloPayments\Client\Model\SupportedCurrencyResponseV2' === '\SplFileObject') {
                        ...
                        if ('\VeloPayments\Client\Model\SupportedCurrencyResponseV2' !== 'string') {
                            try {
     ...
     */
    public function listSupportedCurrenciesV2Async(string $contentType = self::contentTypes['listSupportedCurrenciesV2'][0])
    {
        return $this->listSupportedCurrenciesV2AsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSupportedCurrenciesV2AsyncWithHttpInfo(string $contentType = self::contentTypes['listSupportedCurrenciesV2'][0])
    {
        $returnType = '\VeloPayments\Client\Model\SupportedCurrencyResponseV2';
        $request = $this->listSupportedCurrenciesV2Request($contentType);
     ...
     */
    public function listSupportedCurrenciesV2Request(string $contentType = self::contentTypes['listSupportedCurrenciesV2'][0])
    {
