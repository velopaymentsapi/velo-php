...
/**
 * RegisterMFARequest Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RegisterMFARequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterMFARequest';
     ...
     * Gets mfa_type
     *
     * @return \VeloPayments\Client\Model\MFAType
     */
     ...
     * Sets mfa_type
     *
     * @param \VeloPayments\Client\Model\MFAType $mfa_type mfa_type
     *
     * @return $this
     */
