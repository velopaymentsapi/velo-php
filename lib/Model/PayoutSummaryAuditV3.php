 ...
 */
class PayoutSummaryAuditV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_failed_payments', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($total_failed_payments)) {
            throw new \InvalidArgumentException('non-nullable total_failed_payments cannot be null');
        }
