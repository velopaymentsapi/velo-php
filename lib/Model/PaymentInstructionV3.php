...
class PaymentInstructionV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TRANSMISSION_TYPE_SAME_DAY_ACH = 'SAME_DAY_ACH';
    public const TRANSMISSION_TYPE_WIRE = 'WIRE';
    public const TRANSMISSION_TYPE_ACH = 'ACH';
    public const TRANSMISSION_TYPE_LOCAL = 'LOCAL';
    public const TRANSMISSION_TYPE_SWIFT = 'SWIFT';
    ...
    {
        return [
            self::TRANSMISSION_TYPE_SAME_DAY_ACH,
            self::TRANSMISSION_TYPE_WIRE,
            self::TRANSMISSION_TYPE_ACH,
            self::TRANSMISSION_TYPE_LOCAL,
            self::TRANSMISSION_TYPE_SWIFT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['transmission_type']) && !in_array($this->container['transmission_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'transmission_type', must be one of '%s'",
                $this->container['transmission_type'],
     ...
     *
     * @param string $source_account_name Must match a valid source account name belonging to the payor
     *
     * @return self
     */
     ...
     *
     * @param string|null $transmission_type Optionally choose a specific transmission method for the payment
     *
     * @return self
     */
    public function setTransmissionType($transmission_type)
    {
        ...
        $allowedValues = $this->getTransmissionTypeAllowableValues();
        if (!in_array($transmission_type, $allowedValues, true)) {
