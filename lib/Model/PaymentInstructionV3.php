...
class PaymentInstructionV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if (!is_null($remote_system_id) && (mb_strlen($remote_system_id) > 100)) {
        ...
        if (!is_null($remote_system_id) && (mb_strlen($remote_system_id) < 1)) {
    ...
    {
        if (!is_null($payment_metadata) && (mb_strlen($payment_metadata) > 512)) {
        ...
        if (!is_null($payment_metadata) && (mb_strlen($payment_metadata) < 0)) {
