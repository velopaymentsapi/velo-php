...
/**
 * UpdatePayeeDetailsRequestV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePayeeDetailsRequestV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePayeeDetailsRequestV3';
    ...
    */
    ...
    public function setContactSmsNumber($contact_sms_number)
    {
        ...
        if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($contact_sms_number)))) {
            throw new \InvalidArgumentException("invalid value for \$contact_sms_number when calling UpdatePayeeDetailsRequestV3., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
