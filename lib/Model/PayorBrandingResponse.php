    ...
    */
    ...
    public function setCollectiveAlias($collective_alias)
    {
        if (is_null($collective_alias)) {
            array_push($this->openAPINullablesSetToNull, 'collective_alias');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('collective_alias', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setSupportContact($support_contact)
    {
        if (is_null($support_contact)) {
            array_push($this->openAPINullablesSetToNull, 'support_contact');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('support_contact', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
