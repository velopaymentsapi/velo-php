...
/**
 * FundingDelta Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FundingDelta implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FundingDelta';
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FundingDelta., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($status) < 1)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FundingDelta., must be bigger than or equal to 1.');
        }
     ...
     * Sets amount
     *
     * @param int|null $amount Amount to fund in minor units
     *
     * @return $this
     */
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount > 9999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling FundingDelta., must be smaller than or equal to 9999999999.');
        }
        if (!is_null($amount) && ($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling FundingDelta., must be bigger than or equal to 1.');
        }
