...
/**
 * RegisterSmsRequest Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegisterSmsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterSmsRequest';
    ...
    */
    ...
    public function setSmsNumber($sms_number)
    {
        ...
        if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sms_number)))) {
            throw new \InvalidArgumentException("invalid value for \$sms_number when calling RegisterSmsRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
