...
/**
 * PayeeDetailsChanged Class Doc Comment
 *
 * @category Class
 ...
 */
class PayeeDetailsChanged implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeeDetailsChanged';
