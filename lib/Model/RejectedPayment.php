...
class RejectedPayment implements ModelInterface, ArrayAccess
{
    ...
    const REASON_UNKNOWN_REMOTE_ID = 'UNKNOWN_REMOTE_ID';
    const REASON_UNKNOWN_SOURCE_ACCOUNT = 'UNKNOWN_SOURCE_ACCOUNT';
    const REASON_UNSUPPORTED_CURRENCY = 'UNSUPPORTED_CURRENCY';
    const REASON_PAYMENT_VALUE_TOO_HIGH = 'PAYMENT_VALUE_TOO_HIGH';
    const REASON_UNSUPPORTED_COUNTRY = 'UNSUPPORTED_COUNTRY';
    const REASON_UNSUPPORTED_CURRENCY_FOR_COUNTRY = 'UNSUPPORTED_CURRENCY_FOR_COUNTRY';
    const REASON_PAYEE_NOT_ONBOARDED = 'PAYEE_NOT_ONBOARDED';
    const REASON_COMPLIANCE_ISSUE = 'COMPLIANCE_ISSUE';
    const REASON_DUPLICATE_PAYOR_PAYMENT_ID = 'DUPLICATE_PAYOR_PAYMENT_ID';
    const REASON_CURRENCY_MISMATCH = 'CURRENCY_MISMATCH';
    const REASON_DECLINED_INVITE = 'DECLINED_INVITE';
    const REASON_PENDING_INVITE = 'PENDING_INVITE';
    const REASON_BADLY_FORMED_DATA_ROW = 'BADLY_FORMED_DATA_ROW';
    ...
    {
        return [
            self::REASON_UNKNOWN_REMOTE_ID,
            self::REASON_UNKNOWN_SOURCE_ACCOUNT,
            self::REASON_UNSUPPORTED_CURRENCY,
            self::REASON_PAYMENT_VALUE_TOO_HIGH,
            self::REASON_UNSUPPORTED_COUNTRY,
            self::REASON_UNSUPPORTED_CURRENCY_FOR_COUNTRY,
            self::REASON_PAYEE_NOT_ONBOARDED,
            self::REASON_COMPLIANCE_ISSUE,
            self::REASON_DUPLICATE_PAYOR_PAYMENT_ID,
            self::REASON_CURRENCY_MISMATCH,
            self::REASON_DECLINED_INVITE,
            self::REASON_PENDING_INVITE,
            self::REASON_BADLY_FORMED_DATA_ROW,
            self::REASON_OTHER,
        ];
    }
