...
class PaymentEventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const EVENT_TYPE_ORCHESTRATED_PAYMENT_BATCH_REQUESTED = 'ORCHESTRATED_PAYMENT_BATCH_REQUESTED';
    const EVENT_TYPE_ORCHESTRATED_PAYMENT_BATCH_CONFIRMED = 'ORCHESTRATED_PAYMENT_BATCH_CONFIRMED';
    const EVENT_TYPE_ORCHESTRATED_PAYMENT_REQUESTED = 'ORCHESTRATED_PAYMENT_REQUESTED';
    ...
    public function getEventTypeAllowableValues()
    {
        return [
            ...
            self::EVENT_TYPE_ORCHESTRATED_PAYMENT_BATCH_REQUESTED,
            self::EVENT_TYPE_ORCHESTRATED_PAYMENT_BATCH_CONFIRMED,
            self::EVENT_TYPE_ORCHESTRATED_PAYMENT_REQUESTED,
        ];
    }
