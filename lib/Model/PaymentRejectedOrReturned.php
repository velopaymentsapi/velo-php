...
/**
 * PaymentRejectedOrReturned Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentRejectedOrReturned implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRejectedOrReturned';
