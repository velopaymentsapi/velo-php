...
/**
 * CreatePayee2 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePayee2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePayee_2';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'remote_id' => 'string',
        'type' => '\VeloPayments\Client\Model\PayeeType2',
        'address' => '\VeloPayments\Client\Model\CreatePayeeAddress2',
        'payment_channel' => '\VeloPayments\Client\Model\CreatePaymentChannel2',
        'challenge' => '\VeloPayments\Client\Model\Challenge2',
        'language' => 'string',
        'company' => '\VeloPayments\Client\Model\Company2',
        'individual' => '\VeloPayments\Client\Model\CreateIndividual2'
    ];
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayee2., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayee2., must be bigger than or equal to 3.');
        }
    ...
    public function setRemoteId($remote_id)
    {
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayee2., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayee2., must be bigger than or equal to 1.');
        }
     ...
     * Gets type
     *
     * @return \VeloPayments\Client\Model\PayeeType2
     */
     ...
     * Sets type
     *
     * @param \VeloPayments\Client\Model\PayeeType2 $type type
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \VeloPayments\Client\Model\CreatePayeeAddress2
     */
     ...
     * Sets address
     *
     * @param \VeloPayments\Client\Model\CreatePayeeAddress2 $address address
     *
     * @return self
     */
     ...
     *
     * @return \VeloPayments\Client\Model\CreatePaymentChannel2|null
     */
     ...
     *
     * @param \VeloPayments\Client\Model\CreatePaymentChannel2|null $payment_channel payment_channel
     *
     * @return self
     */
     ...
     * Gets individual
     *
     * @return \VeloPayments\Client\Model\CreateIndividual2|null
     */
     ...
     * Sets individual
     *
     * @param \VeloPayments\Client\Model\CreateIndividual2|null $individual individual
     *
     * @return self
     */
