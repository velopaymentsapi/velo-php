...
/**
 * PayorAddress Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayorAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayorAddress';
    ...
    */
    ...
    public function setLine1($line1)
    {
        ...
        if ((mb_strlen($line1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling PayorAddress., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($line1) < 2)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling PayorAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setLine2($line2)
    {
        ...
        if (!is_null($line2) && (mb_strlen($line2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling PayorAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($line2) && (mb_strlen($line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $line2 when calling PayorAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setLine3($line3)
    {
        ...
        if (!is_null($line3) && (mb_strlen($line3) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line3 when calling PayorAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($line3) && (mb_strlen($line3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $line3 when calling PayorAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setLine4($line4)
    {
        ...
        if (!is_null($line4) && (mb_strlen($line4) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line4 when calling PayorAddress., must be smaller than or equal to 255.');
        }
        if (!is_null($line4) && (mb_strlen($line4) < 0)) {
            throw new \InvalidArgumentException('invalid length for $line4 when calling PayorAddress., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PayorAddress., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $city when calling PayorAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setCountyOrProvince($county_or_province)
    {
        ...
        if (!is_null($county_or_province) && (mb_strlen($county_or_province) > 100)) {
            throw new \InvalidArgumentException('invalid length for $county_or_province when calling PayorAddress., must be smaller than or equal to 100.');
        }
        if (!is_null($county_or_province) && (mb_strlen($county_or_province) < 2)) {
            throw new \InvalidArgumentException('invalid length for $county_or_province when calling PayorAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setZipOrPostcode($zip_or_postcode)
    {
        ...
        if (!is_null($zip_or_postcode) && (mb_strlen($zip_or_postcode) > 30)) {
            throw new \InvalidArgumentException('invalid length for $zip_or_postcode when calling PayorAddress., must be smaller than or equal to 30.');
        }
        if (!is_null($zip_or_postcode) && (mb_strlen($zip_or_postcode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $zip_or_postcode when calling PayorAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 50)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PayorAddress., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling PayorAddress., must be bigger than or equal to 2.');
        }
