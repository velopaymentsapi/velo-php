...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function setLine1($line1)
    {
        ...
        if ((mb_strlen($line1) < 2)) {
            throw new \InvalidArgumentException('invalid length for $line1 when calling Address., must be bigger than or equal to 2.');
        }
    ...
    public function setLine3($line3)
    {
        if (!is_null($line3) && (mb_strlen($line3) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line3 when calling Address., must be smaller than or equal to 255.');
        }
    ...
    public function setLine4($line4)
    {
        if (!is_null($line4) && (mb_strlen($line4) > 255)) {
            throw new \InvalidArgumentException('invalid length for $line4 when calling Address., must be smaller than or equal to 255.');
        }
    ...
    public function setCountyOrProvince($county_or_province)
    {
        if (!is_null($county_or_province) && (mb_strlen($county_or_province) > 100)) {
            throw new \InvalidArgumentException('invalid length for $county_or_province when calling Address., must be smaller than or equal to 100.');
        }
        if (!is_null($county_or_province) && (mb_strlen($county_or_province) < 2)) {
            throw new \InvalidArgumentException('invalid length for $county_or_province when calling Address., must be bigger than or equal to 2.');
        }
    ...
    public function setZipOrPostcode($zip_or_postcode)
    {
        if (!is_null($zip_or_postcode) && (mb_strlen($zip_or_postcode) > 30)) {
            throw new \InvalidArgumentException('invalid length for $zip_or_postcode when calling Address., must be smaller than or equal to 30.');
        }
        if (!is_null($zip_or_postcode) && (mb_strlen($zip_or_postcode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $zip_or_postcode when calling Address., must be bigger than or equal to 2.');
        }
