 ...
 * @link     https://openapi-generator.tech
 */
class EmailUpdateRequest implements ModelInterface, ArrayAccess
{
    ...
    public function setVerificationCode($verification_code)
    {
        if (!is_null($verification_code) && (mb_strlen($verification_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling EmailUpdateRequest., must be smaller than or equal to 6.');
        }
        if (!is_null($verification_code) && (mb_strlen($verification_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling EmailUpdateRequest., must be bigger than or equal to 6.');
        }
