...
/**
 * CreatePayeesCSVRequest2 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePayeesCSVRequest2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePayeesCSVRequest_2';
    ...
    const ADDRESS_COUNTRY_AF = 'AF';
    const ADDRESS_COUNTRY_AX = 'AX';
    const ADDRESS_COUNTRY_AL = 'AL';
    const ADDRESS_COUNTRY_DZ = 'DZ';
    const ADDRESS_COUNTRY__AS = 'AS';
    const ADDRESS_COUNTRY_AD = 'AD';
    const ADDRESS_COUNTRY_AO = 'AO';
    const ADDRESS_COUNTRY_AI = 'AI';
    const ADDRESS_COUNTRY_AQ = 'AQ';
    const ADDRESS_COUNTRY_AG = 'AG';
    const ADDRESS_COUNTRY_AR = 'AR';
    const ADDRESS_COUNTRY_AM = 'AM';
    const ADDRESS_COUNTRY_AW = 'AW';
    const ADDRESS_COUNTRY_AU = 'AU';
    const ADDRESS_COUNTRY_AT = 'AT';
    const ADDRESS_COUNTRY_AZ = 'AZ';
    const ADDRESS_COUNTRY_BS = 'BS';
    const ADDRESS_COUNTRY_BH = 'BH';
    const ADDRESS_COUNTRY_BD = 'BD';
    const ADDRESS_COUNTRY_BB = 'BB';
    const ADDRESS_COUNTRY_BY = 'BY';
    const ADDRESS_COUNTRY_BE = 'BE';
    const ADDRESS_COUNTRY_BZ = 'BZ';
    const ADDRESS_COUNTRY_BJ = 'BJ';
    const ADDRESS_COUNTRY_BM = 'BM';
    const ADDRESS_COUNTRY_BT = 'BT';
    const ADDRESS_COUNTRY_BO = 'BO';
    const ADDRESS_COUNTRY_BQ = 'BQ';
    const ADDRESS_COUNTRY_BA = 'BA';
    const ADDRESS_COUNTRY_BW = 'BW';
    const ADDRESS_COUNTRY_BV = 'BV';
    const ADDRESS_COUNTRY_BR = 'BR';
    const ADDRESS_COUNTRY_IO = 'IO';
    const ADDRESS_COUNTRY_BN = 'BN';
    const ADDRESS_COUNTRY_BG = 'BG';
    const ADDRESS_COUNTRY_BF = 'BF';
    const ADDRESS_COUNTRY_BI = 'BI';
    const ADDRESS_COUNTRY_KH = 'KH';
    const ADDRESS_COUNTRY_CM = 'CM';
    const ADDRESS_COUNTRY_CA = 'CA';
    const ADDRESS_COUNTRY_CV = 'CV';
    const ADDRESS_COUNTRY_KY = 'KY';
    const ADDRESS_COUNTRY_CF = 'CF';
    const ADDRESS_COUNTRY_TD = 'TD';
    const ADDRESS_COUNTRY_CL = 'CL';
    const ADDRESS_COUNTRY_CN = 'CN';
    const ADDRESS_COUNTRY_CX = 'CX';
    const ADDRESS_COUNTRY_CC = 'CC';
    const ADDRESS_COUNTRY_CO = 'CO';
    const ADDRESS_COUNTRY_KM = 'KM';
    const ADDRESS_COUNTRY_CG = 'CG';
    const ADDRESS_COUNTRY_CD = 'CD';
    const ADDRESS_COUNTRY_CK = 'CK';
    const ADDRESS_COUNTRY_CR = 'CR';
    const ADDRESS_COUNTRY_CI = 'CI';
    const ADDRESS_COUNTRY_HR = 'HR';
    const ADDRESS_COUNTRY_CU = 'CU';
    const ADDRESS_COUNTRY_CW = 'CW';
    const ADDRESS_COUNTRY_CY = 'CY';
    const ADDRESS_COUNTRY_CZ = 'CZ';
    const ADDRESS_COUNTRY_DK = 'DK';
    const ADDRESS_COUNTRY_DJ = 'DJ';
    const ADDRESS_COUNTRY_DM = 'DM';
    const ADDRESS_COUNTRY__DO = 'DO';
    const ADDRESS_COUNTRY_EC = 'EC';
    const ADDRESS_COUNTRY_EG = 'EG';
    const ADDRESS_COUNTRY_SV = 'SV';
    const ADDRESS_COUNTRY_GQ = 'GQ';
    const ADDRESS_COUNTRY_ER = 'ER';
    const ADDRESS_COUNTRY_EE = 'EE';
    const ADDRESS_COUNTRY_ET = 'ET';
    const ADDRESS_COUNTRY_FK = 'FK';
    const ADDRESS_COUNTRY_FO = 'FO';
    const ADDRESS_COUNTRY_FJ = 'FJ';
    const ADDRESS_COUNTRY_FI = 'FI';
    const ADDRESS_COUNTRY_FR = 'FR';
    const ADDRESS_COUNTRY_GF = 'GF';
    const ADDRESS_COUNTRY_PF = 'PF';
    const ADDRESS_COUNTRY_TF = 'TF';
    const ADDRESS_COUNTRY_GA = 'GA';
    const ADDRESS_COUNTRY_GM = 'GM';
    const ADDRESS_COUNTRY_GE = 'GE';
    const ADDRESS_COUNTRY_DE = 'DE';
    const ADDRESS_COUNTRY_GH = 'GH';
    const ADDRESS_COUNTRY_GI = 'GI';
    const ADDRESS_COUNTRY_GR = 'GR';
    const ADDRESS_COUNTRY_GL = 'GL';
    const ADDRESS_COUNTRY_GD = 'GD';
    const ADDRESS_COUNTRY_GP = 'GP';
    const ADDRESS_COUNTRY_GU = 'GU';
    const ADDRESS_COUNTRY_GT = 'GT';
    const ADDRESS_COUNTRY_GG = 'GG';
    const ADDRESS_COUNTRY_GN = 'GN';
    const ADDRESS_COUNTRY_GW = 'GW';
    const ADDRESS_COUNTRY_GY = 'GY';
    const ADDRESS_COUNTRY_HT = 'HT';
    const ADDRESS_COUNTRY_HM = 'HM';
    const ADDRESS_COUNTRY_VA = 'VA';
    const ADDRESS_COUNTRY_HN = 'HN';
    const ADDRESS_COUNTRY_HK = 'HK';
    const ADDRESS_COUNTRY_HU = 'HU';
    const ADDRESS_COUNTRY_IS = 'IS';
    const ADDRESS_COUNTRY_IN = 'IN';
    const ADDRESS_COUNTRY_ID = 'ID';
    const ADDRESS_COUNTRY_IR = 'IR';
    const ADDRESS_COUNTRY_IQ = 'IQ';
    const ADDRESS_COUNTRY_IE = 'IE';
    const ADDRESS_COUNTRY_IM = 'IM';
    const ADDRESS_COUNTRY_IL = 'IL';
    const ADDRESS_COUNTRY_IT = 'IT';
    const ADDRESS_COUNTRY_JM = 'JM';
    const ADDRESS_COUNTRY_JP = 'JP';
    const ADDRESS_COUNTRY_JE = 'JE';
    const ADDRESS_COUNTRY_JO = 'JO';
    const ADDRESS_COUNTRY_KZ = 'KZ';
    const ADDRESS_COUNTRY_KE = 'KE';
    const ADDRESS_COUNTRY_KI = 'KI';
    const ADDRESS_COUNTRY_KP = 'KP';
    const ADDRESS_COUNTRY_KR = 'KR';
    const ADDRESS_COUNTRY_KW = 'KW';
    const ADDRESS_COUNTRY_KG = 'KG';
    const ADDRESS_COUNTRY_LA = 'LA';
    const ADDRESS_COUNTRY_LV = 'LV';
    const ADDRESS_COUNTRY_LB = 'LB';
    const ADDRESS_COUNTRY_LS = 'LS';
    const ADDRESS_COUNTRY_LR = 'LR';
    const ADDRESS_COUNTRY_LY = 'LY';
    const ADDRESS_COUNTRY_LI = 'LI';
    const ADDRESS_COUNTRY_LT = 'LT';
    const ADDRESS_COUNTRY_LU = 'LU';
    const ADDRESS_COUNTRY_MO = 'MO';
    const ADDRESS_COUNTRY_MK = 'MK';
    const ADDRESS_COUNTRY_MG = 'MG';
    const ADDRESS_COUNTRY_MW = 'MW';
    const ADDRESS_COUNTRY_MY = 'MY';
    const ADDRESS_COUNTRY_MV = 'MV';
    const ADDRESS_COUNTRY_ML = 'ML';
    const ADDRESS_COUNTRY_MT = 'MT';
    const ADDRESS_COUNTRY_MH = 'MH';
    const ADDRESS_COUNTRY_MQ = 'MQ';
    const ADDRESS_COUNTRY_MR = 'MR';
    const ADDRESS_COUNTRY_MU = 'MU';
    const ADDRESS_COUNTRY_YT = 'YT';
    const ADDRESS_COUNTRY_MX = 'MX';
    const ADDRESS_COUNTRY_FM = 'FM';
    const ADDRESS_COUNTRY_MD = 'MD';
    const ADDRESS_COUNTRY_MC = 'MC';
    const ADDRESS_COUNTRY_MN = 'MN';
    const ADDRESS_COUNTRY_ME = 'ME';
    const ADDRESS_COUNTRY_MS = 'MS';
    const ADDRESS_COUNTRY_MA = 'MA';
    const ADDRESS_COUNTRY_MZ = 'MZ';
    const ADDRESS_COUNTRY_MM = 'MM';
    const ADDRESS_COUNTRY_NA = 'NA';
    const ADDRESS_COUNTRY_NR = 'NR';
    const ADDRESS_COUNTRY_NP = 'NP';
    const ADDRESS_COUNTRY_NL = 'NL';
    const ADDRESS_COUNTRY_NC = 'NC';
    const ADDRESS_COUNTRY_NZ = 'NZ';
    const ADDRESS_COUNTRY_NI = 'NI';
    const ADDRESS_COUNTRY_NE = 'NE';
    const ADDRESS_COUNTRY_NG = 'NG';
    const ADDRESS_COUNTRY_NU = 'NU';
    const ADDRESS_COUNTRY_NF = 'NF';
    const ADDRESS_COUNTRY_MP = 'MP';
    const ADDRESS_COUNTRY_FALSE = 'false';
    const ADDRESS_COUNTRY_OM = 'OM';
    const ADDRESS_COUNTRY_PK = 'PK';
    const ADDRESS_COUNTRY_PW = 'PW';
    const ADDRESS_COUNTRY_PS = 'PS';
    const ADDRESS_COUNTRY_PA = 'PA';
    const ADDRESS_COUNTRY_PG = 'PG';
    const ADDRESS_COUNTRY_PY = 'PY';
    const ADDRESS_COUNTRY_PE = 'PE';
    const ADDRESS_COUNTRY_PH = 'PH';
    const ADDRESS_COUNTRY_PN = 'PN';
    const ADDRESS_COUNTRY_PL = 'PL';
    const ADDRESS_COUNTRY_PT = 'PT';
    const ADDRESS_COUNTRY_PR = 'PR';
    const ADDRESS_COUNTRY_QA = 'QA';
    const ADDRESS_COUNTRY_RE = 'RE';
    const ADDRESS_COUNTRY_RO = 'RO';
    const ADDRESS_COUNTRY_RU = 'RU';
    const ADDRESS_COUNTRY_RW = 'RW';
    const ADDRESS_COUNTRY_BL = 'BL';
    const ADDRESS_COUNTRY_SH = 'SH';
    const ADDRESS_COUNTRY_KN = 'KN';
    const ADDRESS_COUNTRY_LC = 'LC';
    const ADDRESS_COUNTRY_MF = 'MF';
    const ADDRESS_COUNTRY_PM = 'PM';
    const ADDRESS_COUNTRY_VC = 'VC';
    const ADDRESS_COUNTRY_WS = 'WS';
    const ADDRESS_COUNTRY_SM = 'SM';
    const ADDRESS_COUNTRY_ST = 'ST';
    const ADDRESS_COUNTRY_SA = 'SA';
    const ADDRESS_COUNTRY_SN = 'SN';
    const ADDRESS_COUNTRY_RS = 'RS';
    const ADDRESS_COUNTRY_SC = 'SC';
    const ADDRESS_COUNTRY_SL = 'SL';
    const ADDRESS_COUNTRY_SG = 'SG';
    const ADDRESS_COUNTRY_SX = 'SX';
    const ADDRESS_COUNTRY_SK = 'SK';
    const ADDRESS_COUNTRY_SI = 'SI';
    const ADDRESS_COUNTRY_SB = 'SB';
    const ADDRESS_COUNTRY_SO = 'SO';
    const ADDRESS_COUNTRY_ZA = 'ZA';
    const ADDRESS_COUNTRY_GS = 'GS';
    const ADDRESS_COUNTRY_SS = 'SS';
    const ADDRESS_COUNTRY_ES = 'ES';
    const ADDRESS_COUNTRY_LK = 'LK';
    const ADDRESS_COUNTRY_SD = 'SD';
    const ADDRESS_COUNTRY_SR = 'SR';
    const ADDRESS_COUNTRY_SJ = 'SJ';
    const ADDRESS_COUNTRY_SZ = 'SZ';
    const ADDRESS_COUNTRY_SE = 'SE';
    const ADDRESS_COUNTRY_CH = 'CH';
    const ADDRESS_COUNTRY_SY = 'SY';
    const ADDRESS_COUNTRY_TW = 'TW';
    const ADDRESS_COUNTRY_TJ = 'TJ';
    const ADDRESS_COUNTRY_TZ = 'TZ';
    const ADDRESS_COUNTRY_TH = 'TH';
    const ADDRESS_COUNTRY_TL = 'TL';
    const ADDRESS_COUNTRY_TG = 'TG';
    const ADDRESS_COUNTRY_TK = 'TK';
    const ADDRESS_COUNTRY_TO = 'TO';
    const ADDRESS_COUNTRY_TT = 'TT';
    const ADDRESS_COUNTRY_TN = 'TN';
    const ADDRESS_COUNTRY_TR = 'TR';
    const ADDRESS_COUNTRY_TM = 'TM';
    const ADDRESS_COUNTRY_TC = 'TC';
    const ADDRESS_COUNTRY_TV = 'TV';
    const ADDRESS_COUNTRY_UG = 'UG';
    const ADDRESS_COUNTRY_UA = 'UA';
    const ADDRESS_COUNTRY_AE = 'AE';
    const ADDRESS_COUNTRY_GB = 'GB';
    const ADDRESS_COUNTRY_US = 'US';
    const ADDRESS_COUNTRY_UM = 'UM';
    const ADDRESS_COUNTRY_UY = 'UY';
    const ADDRESS_COUNTRY_UZ = 'UZ';
    const ADDRESS_COUNTRY_VU = 'VU';
    const ADDRESS_COUNTRY_VE = 'VE';
    const ADDRESS_COUNTRY_VN = 'VN';
    const ADDRESS_COUNTRY_VG = 'VG';
    const ADDRESS_COUNTRY_VI = 'VI';
    const ADDRESS_COUNTRY_WF = 'WF';
    const ADDRESS_COUNTRY_EH = 'EH';
    const ADDRESS_COUNTRY_YE = 'YE';
    const ADDRESS_COUNTRY_ZM = 'ZM';
    const ADDRESS_COUNTRY_ZW = 'ZW';
     ...
     * @return string[]
     */
    public function getAddressCountryAllowableValues()
    {
        return [
            self::ADDRESS_COUNTRY_AF,
            self::ADDRESS_COUNTRY_AX,
            self::ADDRESS_COUNTRY_AL,
            self::ADDRESS_COUNTRY_DZ,
            self::ADDRESS_COUNTRY__AS,
            self::ADDRESS_COUNTRY_AD,
            self::ADDRESS_COUNTRY_AO,
            self::ADDRESS_COUNTRY_AI,
            self::ADDRESS_COUNTRY_AQ,
            self::ADDRESS_COUNTRY_AG,
            self::ADDRESS_COUNTRY_AR,
            self::ADDRESS_COUNTRY_AM,
            self::ADDRESS_COUNTRY_AW,
            self::ADDRESS_COUNTRY_AU,
            self::ADDRESS_COUNTRY_AT,
            self::ADDRESS_COUNTRY_AZ,
            self::ADDRESS_COUNTRY_BS,
            self::ADDRESS_COUNTRY_BH,
            self::ADDRESS_COUNTRY_BD,
            self::ADDRESS_COUNTRY_BB,
            self::ADDRESS_COUNTRY_BY,
            self::ADDRESS_COUNTRY_BE,
            self::ADDRESS_COUNTRY_BZ,
            self::ADDRESS_COUNTRY_BJ,
            self::ADDRESS_COUNTRY_BM,
            self::ADDRESS_COUNTRY_BT,
            self::ADDRESS_COUNTRY_BO,
            self::ADDRESS_COUNTRY_BQ,
            self::ADDRESS_COUNTRY_BA,
            self::ADDRESS_COUNTRY_BW,
            self::ADDRESS_COUNTRY_BV,
            self::ADDRESS_COUNTRY_BR,
            self::ADDRESS_COUNTRY_IO,
            self::ADDRESS_COUNTRY_BN,
            self::ADDRESS_COUNTRY_BG,
            self::ADDRESS_COUNTRY_BF,
            self::ADDRESS_COUNTRY_BI,
            self::ADDRESS_COUNTRY_KH,
            self::ADDRESS_COUNTRY_CM,
            self::ADDRESS_COUNTRY_CA,
            self::ADDRESS_COUNTRY_CV,
            self::ADDRESS_COUNTRY_KY,
            self::ADDRESS_COUNTRY_CF,
            self::ADDRESS_COUNTRY_TD,
            self::ADDRESS_COUNTRY_CL,
            self::ADDRESS_COUNTRY_CN,
            self::ADDRESS_COUNTRY_CX,
            self::ADDRESS_COUNTRY_CC,
            self::ADDRESS_COUNTRY_CO,
            self::ADDRESS_COUNTRY_KM,
            self::ADDRESS_COUNTRY_CG,
            self::ADDRESS_COUNTRY_CD,
            self::ADDRESS_COUNTRY_CK,
            self::ADDRESS_COUNTRY_CR,
            self::ADDRESS_COUNTRY_CI,
            self::ADDRESS_COUNTRY_HR,
            self::ADDRESS_COUNTRY_CU,
            self::ADDRESS_COUNTRY_CW,
            self::ADDRESS_COUNTRY_CY,
            self::ADDRESS_COUNTRY_CZ,
            self::ADDRESS_COUNTRY_DK,
            self::ADDRESS_COUNTRY_DJ,
            self::ADDRESS_COUNTRY_DM,
            self::ADDRESS_COUNTRY__DO,
            self::ADDRESS_COUNTRY_EC,
            self::ADDRESS_COUNTRY_EG,
            self::ADDRESS_COUNTRY_SV,
            self::ADDRESS_COUNTRY_GQ,
            self::ADDRESS_COUNTRY_ER,
            self::ADDRESS_COUNTRY_EE,
            self::ADDRESS_COUNTRY_ET,
            self::ADDRESS_COUNTRY_FK,
            self::ADDRESS_COUNTRY_FO,
            self::ADDRESS_COUNTRY_FJ,
            self::ADDRESS_COUNTRY_FI,
            self::ADDRESS_COUNTRY_FR,
            self::ADDRESS_COUNTRY_GF,
            self::ADDRESS_COUNTRY_PF,
            self::ADDRESS_COUNTRY_TF,
            self::ADDRESS_COUNTRY_GA,
            self::ADDRESS_COUNTRY_GM,
            self::ADDRESS_COUNTRY_GE,
            self::ADDRESS_COUNTRY_DE,
            self::ADDRESS_COUNTRY_GH,
            self::ADDRESS_COUNTRY_GI,
            self::ADDRESS_COUNTRY_GR,
            self::ADDRESS_COUNTRY_GL,
            self::ADDRESS_COUNTRY_GD,
            self::ADDRESS_COUNTRY_GP,
            self::ADDRESS_COUNTRY_GU,
            self::ADDRESS_COUNTRY_GT,
            self::ADDRESS_COUNTRY_GG,
            self::ADDRESS_COUNTRY_GN,
            self::ADDRESS_COUNTRY_GW,
            self::ADDRESS_COUNTRY_GY,
            self::ADDRESS_COUNTRY_HT,
            self::ADDRESS_COUNTRY_HM,
            self::ADDRESS_COUNTRY_VA,
            self::ADDRESS_COUNTRY_HN,
            self::ADDRESS_COUNTRY_HK,
            self::ADDRESS_COUNTRY_HU,
            self::ADDRESS_COUNTRY_IS,
            self::ADDRESS_COUNTRY_IN,
            self::ADDRESS_COUNTRY_ID,
            self::ADDRESS_COUNTRY_IR,
            self::ADDRESS_COUNTRY_IQ,
            self::ADDRESS_COUNTRY_IE,
            self::ADDRESS_COUNTRY_IM,
            self::ADDRESS_COUNTRY_IL,
            self::ADDRESS_COUNTRY_IT,
            self::ADDRESS_COUNTRY_JM,
            self::ADDRESS_COUNTRY_JP,
            self::ADDRESS_COUNTRY_JE,
            self::ADDRESS_COUNTRY_JO,
            self::ADDRESS_COUNTRY_KZ,
            self::ADDRESS_COUNTRY_KE,
            self::ADDRESS_COUNTRY_KI,
            self::ADDRESS_COUNTRY_KP,
            self::ADDRESS_COUNTRY_KR,
            self::ADDRESS_COUNTRY_KW,
            self::ADDRESS_COUNTRY_KG,
            self::ADDRESS_COUNTRY_LA,
            self::ADDRESS_COUNTRY_LV,
            self::ADDRESS_COUNTRY_LB,
            self::ADDRESS_COUNTRY_LS,
            self::ADDRESS_COUNTRY_LR,
            self::ADDRESS_COUNTRY_LY,
            self::ADDRESS_COUNTRY_LI,
            self::ADDRESS_COUNTRY_LT,
            self::ADDRESS_COUNTRY_LU,
            self::ADDRESS_COUNTRY_MO,
            self::ADDRESS_COUNTRY_MK,
            self::ADDRESS_COUNTRY_MG,
            self::ADDRESS_COUNTRY_MW,
            self::ADDRESS_COUNTRY_MY,
            self::ADDRESS_COUNTRY_MV,
            self::ADDRESS_COUNTRY_ML,
            self::ADDRESS_COUNTRY_MT,
            self::ADDRESS_COUNTRY_MH,
            self::ADDRESS_COUNTRY_MQ,
            self::ADDRESS_COUNTRY_MR,
            self::ADDRESS_COUNTRY_MU,
            self::ADDRESS_COUNTRY_YT,
            self::ADDRESS_COUNTRY_MX,
            self::ADDRESS_COUNTRY_FM,
            self::ADDRESS_COUNTRY_MD,
            self::ADDRESS_COUNTRY_MC,
            self::ADDRESS_COUNTRY_MN,
            self::ADDRESS_COUNTRY_ME,
            self::ADDRESS_COUNTRY_MS,
            self::ADDRESS_COUNTRY_MA,
            self::ADDRESS_COUNTRY_MZ,
            self::ADDRESS_COUNTRY_MM,
            self::ADDRESS_COUNTRY_NA,
            self::ADDRESS_COUNTRY_NR,
            self::ADDRESS_COUNTRY_NP,
            self::ADDRESS_COUNTRY_NL,
            self::ADDRESS_COUNTRY_NC,
            self::ADDRESS_COUNTRY_NZ,
            self::ADDRESS_COUNTRY_NI,
            self::ADDRESS_COUNTRY_NE,
            self::ADDRESS_COUNTRY_NG,
            self::ADDRESS_COUNTRY_NU,
            self::ADDRESS_COUNTRY_NF,
            self::ADDRESS_COUNTRY_MP,
            self::ADDRESS_COUNTRY_FALSE,
            self::ADDRESS_COUNTRY_OM,
            self::ADDRESS_COUNTRY_PK,
            self::ADDRESS_COUNTRY_PW,
            self::ADDRESS_COUNTRY_PS,
            self::ADDRESS_COUNTRY_PA,
            self::ADDRESS_COUNTRY_PG,
            self::ADDRESS_COUNTRY_PY,
            self::ADDRESS_COUNTRY_PE,
            self::ADDRESS_COUNTRY_PH,
            self::ADDRESS_COUNTRY_PN,
            self::ADDRESS_COUNTRY_PL,
            self::ADDRESS_COUNTRY_PT,
            self::ADDRESS_COUNTRY_PR,
            self::ADDRESS_COUNTRY_QA,
            self::ADDRESS_COUNTRY_RE,
            self::ADDRESS_COUNTRY_RO,
            self::ADDRESS_COUNTRY_RU,
            self::ADDRESS_COUNTRY_RW,
            self::ADDRESS_COUNTRY_BL,
            self::ADDRESS_COUNTRY_SH,
            self::ADDRESS_COUNTRY_KN,
            self::ADDRESS_COUNTRY_LC,
            self::ADDRESS_COUNTRY_MF,
            self::ADDRESS_COUNTRY_PM,
            self::ADDRESS_COUNTRY_VC,
            self::ADDRESS_COUNTRY_WS,
            self::ADDRESS_COUNTRY_SM,
            self::ADDRESS_COUNTRY_ST,
            self::ADDRESS_COUNTRY_SA,
            self::ADDRESS_COUNTRY_SN,
            self::ADDRESS_COUNTRY_RS,
            self::ADDRESS_COUNTRY_SC,
            self::ADDRESS_COUNTRY_SL,
            self::ADDRESS_COUNTRY_SG,
            self::ADDRESS_COUNTRY_SX,
            self::ADDRESS_COUNTRY_SK,
            self::ADDRESS_COUNTRY_SI,
            self::ADDRESS_COUNTRY_SB,
            self::ADDRESS_COUNTRY_SO,
            self::ADDRESS_COUNTRY_ZA,
            self::ADDRESS_COUNTRY_GS,
            self::ADDRESS_COUNTRY_SS,
            self::ADDRESS_COUNTRY_ES,
            self::ADDRESS_COUNTRY_LK,
            self::ADDRESS_COUNTRY_SD,
            self::ADDRESS_COUNTRY_SR,
            self::ADDRESS_COUNTRY_SJ,
            self::ADDRESS_COUNTRY_SZ,
            self::ADDRESS_COUNTRY_SE,
            self::ADDRESS_COUNTRY_CH,
            self::ADDRESS_COUNTRY_SY,
            self::ADDRESS_COUNTRY_TW,
            self::ADDRESS_COUNTRY_TJ,
            self::ADDRESS_COUNTRY_TZ,
            self::ADDRESS_COUNTRY_TH,
            self::ADDRESS_COUNTRY_TL,
            self::ADDRESS_COUNTRY_TG,
            self::ADDRESS_COUNTRY_TK,
            self::ADDRESS_COUNTRY_TO,
            self::ADDRESS_COUNTRY_TT,
            self::ADDRESS_COUNTRY_TN,
            self::ADDRESS_COUNTRY_TR,
            self::ADDRESS_COUNTRY_TM,
            self::ADDRESS_COUNTRY_TC,
            self::ADDRESS_COUNTRY_TV,
            self::ADDRESS_COUNTRY_UG,
            self::ADDRESS_COUNTRY_UA,
            self::ADDRESS_COUNTRY_AE,
            self::ADDRESS_COUNTRY_GB,
            self::ADDRESS_COUNTRY_US,
            self::ADDRESS_COUNTRY_UM,
            self::ADDRESS_COUNTRY_UY,
            self::ADDRESS_COUNTRY_UZ,
            self::ADDRESS_COUNTRY_VU,
            self::ADDRESS_COUNTRY_VE,
            self::ADDRESS_COUNTRY_VN,
            self::ADDRESS_COUNTRY_VG,
            self::ADDRESS_COUNTRY_VI,
            self::ADDRESS_COUNTRY_WF,
            self::ADDRESS_COUNTRY_EH,
            self::ADDRESS_COUNTRY_YE,
            self::ADDRESS_COUNTRY_ZM,
            self::ADDRESS_COUNTRY_ZW,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['address_county_or_province'] = $data['address_county_or_province'] ?? null;
        $this->container['address_zip_or_postcode'] = $data['address_zip_or_postcode'] ?? null;
        $this->container['address_country'] = $data['address_country'] ?? null;
        $this->container['individual_national_identification'] = $data['individual_national_identification'] ?? null;
        $this->container['individual_date_of_birth'] = $data['individual_date_of_birth'] ?? null;
        $this->container['individual_title'] = $data['individual_title'] ?? null;
        $this->container['individual_first_name'] = $data['individual_first_name'] ?? null;
        $this->container['individual_other_names'] = $data['individual_other_names'] ?? null;
        $this->container['individual_last_name'] = $data['individual_last_name'] ?? null;
        $this->container['company_name'] = $data['company_name'] ?? null;
        $this->container['company_ein'] = $data['company_ein'] ?? null;
        $this->container['company_operating_name'] = $data['company_operating_name'] ?? null;
        $this->container['payment_channel_account_number'] = $data['payment_channel_account_number'] ?? null;
        $this->container['payment_channel_routing_number'] = $data['payment_channel_routing_number'] ?? null;
        $this->container['payment_channel_account_name'] = $data['payment_channel_account_name'] ?? null;
        $this->container['payment_channel_iban'] = $data['payment_channel_iban'] ?? null;
        $this->container['payment_channel_country_code'] = $data['payment_channel_country_code'] ?? null;
        $this->container['payment_channel_currency'] = $data['payment_channel_currency'] ?? null;
        $this->container['challenge_description'] = $data['challenge_description'] ?? null;
        $this->container['challenge_value'] = $data['challenge_value'] ?? null;
        $this->container['payee_language'] = $data['payee_language'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAddressCountryAllowableValues();
        if (!is_null($this->container['address_country']) && !in_array($this->container['address_country'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'address_country', must be one of '%s'",
    ...
    public function setRemoteId($remote_id)
    {
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeesCSVRequest2., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeesCSVRequest2., must be bigger than or equal to 3.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        if ((mb_strlen($address_line1) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($address_line1) < 2)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling CreatePayeesCSVRequest2., must be bigger than or equal to 2.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if (!is_null($address_line2) && (mb_strlen($address_line2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling CreatePayeesCSVRequest2., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        if (!is_null($address_line3) && (mb_strlen($address_line3) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if (!is_null($address_line3) && (mb_strlen($address_line3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling CreatePayeesCSVRequest2., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressLine4($address_line4)
    {
        if (!is_null($address_line4) && (mb_strlen($address_line4) > 100)) {
            throw new \InvalidArgumentException('invalid length for $address_line4 when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if (!is_null($address_line4) && (mb_strlen($address_line4) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address_line4 when calling CreatePayeesCSVRequest2., must be bigger than or equal to 0.');
        }
    ...
    public function setAddressCity($address_city)
    {
        if ((mb_strlen($address_city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling CreatePayeesCSVRequest2., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($address_city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling CreatePayeesCSVRequest2., must be bigger than or equal to 2.');
        }
    ...
    public function setAddressCountyOrProvince($address_county_or_province)
    {
        if (!is_null($address_county_or_province) && (mb_strlen($address_county_or_province) > 50)) {
            throw new \InvalidArgumentException('invalid length for $address_county_or_province when calling CreatePayeesCSVRequest2., must be smaller than or equal to 50.');
        }
        if (!is_null($address_county_or_province) && (mb_strlen($address_county_or_province) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_county_or_province when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressZipOrPostcode($address_zip_or_postcode)
    {
        if ((mb_strlen($address_zip_or_postcode) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address_zip_or_postcode when calling CreatePayeesCSVRequest2., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($address_zip_or_postcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_zip_or_postcode when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $address_country Must be a 2 character country code - per ISO 3166-1
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getAddressCountryAllowableValues();
        if (!in_array($address_country, $allowedValues, true)) {
        ...
        if ((mb_strlen($address_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling CreatePayeesCSVRequest2., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($address_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling CreatePayeesCSVRequest2., must be bigger than or equal to 2.');
        }
    ...
    public function setIndividualNationalIdentification($individual_national_identification)
    {
        if (!is_null($individual_national_identification) && (mb_strlen($individual_national_identification) > 30)) {
            throw new \InvalidArgumentException('invalid length for $individual_national_identification when calling CreatePayeesCSVRequest2., must be smaller than or equal to 30.');
        }
        if (!is_null($individual_national_identification) && (mb_strlen($individual_national_identification) < 6)) {
            throw new \InvalidArgumentException('invalid length for $individual_national_identification when calling CreatePayeesCSVRequest2., must be bigger than or equal to 6.');
        }
    ...
    public function setIndividualTitle($individual_title)
    {
        if (!is_null($individual_title) && (mb_strlen($individual_title) > 40)) {
            throw new \InvalidArgumentException('invalid length for $individual_title when calling CreatePayeesCSVRequest2., must be smaller than or equal to 40.');
        }
        if (!is_null($individual_title) && (mb_strlen($individual_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $individual_title when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setIndividualFirstName($individual_first_name)
    {
        if (!is_null($individual_first_name) && (mb_strlen($individual_first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $individual_first_name when calling CreatePayeesCSVRequest2., must be smaller than or equal to 40.');
        }
        if (!is_null($individual_first_name) && (mb_strlen($individual_first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $individual_first_name when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setIndividualOtherNames($individual_other_names)
    {
        if (!is_null($individual_other_names) && (mb_strlen($individual_other_names) > 40)) {
            throw new \InvalidArgumentException('invalid length for $individual_other_names when calling CreatePayeesCSVRequest2., must be smaller than or equal to 40.');
        }
        if (!is_null($individual_other_names) && (mb_strlen($individual_other_names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $individual_other_names when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setIndividualLastName($individual_last_name)
    {
        if (!is_null($individual_last_name) && (mb_strlen($individual_last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $individual_last_name when calling CreatePayeesCSVRequest2., must be smaller than or equal to 40.');
        }
        if (!is_null($individual_last_name) && (mb_strlen($individual_last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $individual_last_name when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling CreatePayeesCSVRequest2., must be smaller than or equal to 40.');
        }
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($company_ein) && (mb_strlen($company_ein) > 30)) {
            throw new \InvalidArgumentException('invalid length for $company_ein when calling CreatePayeesCSVRequest2., must be smaller than or equal to 30.');
        }
        if (!is_null($company_ein) && (mb_strlen($company_ein) < 6)) {
            throw new \InvalidArgumentException('invalid length for $company_ein when calling CreatePayeesCSVRequest2., must be bigger than or equal to 6.');
        }
    ...
    public function setCompanyOperatingName($company_operating_name)
    {
        if (!is_null($company_operating_name) && (mb_strlen($company_operating_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $company_operating_name when calling CreatePayeesCSVRequest2., must be smaller than or equal to 100.');
        }
        if (!is_null($company_operating_name) && (mb_strlen($company_operating_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_operating_name when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentChannelAccountNumber($payment_channel_account_number)
    {
        if (!is_null($payment_channel_account_number) && (mb_strlen($payment_channel_account_number) > 17)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_account_number when calling CreatePayeesCSVRequest2., must be smaller than or equal to 17.');
        }
        if (!is_null($payment_channel_account_number) && (mb_strlen($payment_channel_account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_account_number when calling CreatePayeesCSVRequest2., must be bigger than or equal to 6.');
        }
    ...
    public function setPaymentChannelRoutingNumber($payment_channel_routing_number)
    {
        if (!is_null($payment_channel_routing_number) && (mb_strlen($payment_channel_routing_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_routing_number when calling CreatePayeesCSVRequest2., must be smaller than or equal to 9.');
        }
        if (!is_null($payment_channel_routing_number) && (mb_strlen($payment_channel_routing_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_routing_number when calling CreatePayeesCSVRequest2., must be bigger than or equal to 9.');
        }
    ...
    public function setPaymentChannelIban($payment_channel_iban)
    {
        if (!is_null($payment_channel_iban) && (mb_strlen($payment_channel_iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_iban when calling CreatePayeesCSVRequest2., must be smaller than or equal to 34.');
        }
        if (!is_null($payment_channel_iban) && (mb_strlen($payment_channel_iban) < 15)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_iban when calling CreatePayeesCSVRequest2., must be bigger than or equal to 15.');
        }
        if (!is_null($payment_channel_iban) && (!preg_match("/^[A-Za-z0-9]+$/", $payment_channel_iban))) {
            throw new \InvalidArgumentException("invalid value for $payment_channel_iban when calling CreatePayeesCSVRequest2., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
    ...
    public function setPaymentChannelCountryCode($payment_channel_country_code)
    {
        ...
        if (!is_null($payment_channel_country_code) && (mb_strlen($payment_channel_country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_country_code when calling CreatePayeesCSVRequest2., must be smaller than or equal to 2.');
        }
        if (!is_null($payment_channel_country_code) && (mb_strlen($payment_channel_country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_country_code when calling CreatePayeesCSVRequest2., must be bigger than or equal to 2.');
        }
    ...
    public function setChallengeDescription($challenge_description)
    {
        if (!is_null($challenge_description) && (mb_strlen($challenge_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $challenge_description when calling CreatePayeesCSVRequest2., must be smaller than or equal to 255.');
        }
        if (!is_null($challenge_description) && (mb_strlen($challenge_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $challenge_description when calling CreatePayeesCSVRequest2., must be bigger than or equal to 1.');
        }
    ...
    public function setChallengeValue($challenge_value)
    {
        if (!is_null($challenge_value) && (mb_strlen($challenge_value) > 20)) {
            throw new \InvalidArgumentException('invalid length for $challenge_value when calling CreatePayeesCSVRequest2., must be smaller than or equal to 20.');
        }
        if (!is_null($challenge_value) && (mb_strlen($challenge_value) < 3)) {
            throw new \InvalidArgumentException('invalid length for $challenge_value when calling CreatePayeesCSVRequest2., must be bigger than or equal to 3.');
        }
