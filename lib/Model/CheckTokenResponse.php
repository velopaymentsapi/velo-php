...
class CheckTokenResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'token_type' => '\VeloPayments\Client\Model\TokenType',
        'mfa_verified' => 'bool',
        'mfa_status' => '\VeloPayments\Client\Model\MFAStatus'
    ];
     ...
     * Sets expiry_date
     *
     * @param \DateTime|null $expiry_date the timestamp when the token will expire
     *
     * @return $this
     */
     ...
     * Gets token_type
     *
     * @return \VeloPayments\Client\Model\TokenType|null
     */
     ...
     * Sets token_type
     *
     * @param \VeloPayments\Client\Model\TokenType|null $token_type token_type
     *
     * @return $this
     */
     ...
     * Sets mfa_verified
     *
     * @param bool|null $mfa_verified has the user verified their MFA device by logging in
     *
     * @return $this
     */
     ...
     * Gets mfa_status
     *
     * @return \VeloPayments\Client\Model\MFAStatus|null
     */
     ...
     * Sets mfa_status
     *
     * @param \VeloPayments\Client\Model\MFAStatus|null $mfa_status mfa_status
     *
     * @return $this
     */
