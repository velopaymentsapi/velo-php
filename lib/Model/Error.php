...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const LOCATION_TYPE_REQUEST_BODY = 'requestBody';
    const LOCATION_TYPE_QUERY_PARAM = 'queryParam';
    const LOCATION_TYPE_REQUEST_PARAM = 'requestParam';
    const LOCATION_TYPE_HEADER = 'header';
    const LOCATION_TYPE_PATH_PARAM = 'pathParam';
