...
/**
 * UnregisterMFARequest Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class UnregisterMFARequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnregisterMFARequest';
    ...
    */
     ...
     * Sets mfa_type
     *
     * @param string $mfa_type The type of the MFA device
     *
     * @return self
     */
    ...
    public function setVerificationCode($verification_code)
    {
        ...
        if (!is_null($verification_code) && (mb_strlen($verification_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling UnregisterMFARequest., must be smaller than or equal to 6.');
        }
        if (!is_null($verification_code) && (mb_strlen($verification_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling UnregisterMFARequest., must be bigger than or equal to 6.');
        }
