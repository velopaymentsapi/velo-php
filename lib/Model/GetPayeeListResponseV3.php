...
/**
 * GetPayeeListResponseV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetPayeeListResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPayeeListResponseV3';
    ...
    protected static $openAPITypes = [
        ...
        'individual' => '\VeloPayments\Client\Model\GetPayeeListResponseIndividualV3',
        'company' => '\VeloPayments\Client\Model\GetPayeeListResponseCompanyV3'
    ];
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling GetPayeeListResponseV3., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling GetPayeeListResponseV3., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country)))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling GetPayeeListResponseV3., must conform to the pattern /^[A-Z]{2}$/.");
        }
     ...
     * Gets individual
     *
     * @return \VeloPayments\Client\Model\GetPayeeListResponseIndividualV3|null
     */
     ...
     * Sets individual
     *
     * @param \VeloPayments\Client\Model\GetPayeeListResponseIndividualV3|null $individual individual
     *
     * @return self
     */
     ...
     * Gets company
     *
     * @return \VeloPayments\Client\Model\GetPayeeListResponseCompanyV3|null
     */
     ...
     * Sets company
     *
     * @param \VeloPayments\Client\Model\GetPayeeListResponseCompanyV3|null $company company
     *
     * @return self
     */
