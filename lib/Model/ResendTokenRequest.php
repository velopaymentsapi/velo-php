...
class ResendTokenRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $verification_code Optional property that MUST be suppied when manually verifying a user <P> The user's smsNumber is registered via a separate endpoint and an OTP sent to them
     *
     * @return $this
     */
