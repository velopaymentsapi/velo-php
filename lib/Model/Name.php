...
class Name implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 10)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Name., must be smaller than or equal to 10.');
        }
        if (!is_null($title) && (mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Name., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Name., must be smaller than or equal to 40.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Name., must be bigger than or equal to 1.');
        }
    ...
    public function setOtherNames($other_names)
    {
        if (!is_null($other_names) && (mb_strlen($other_names) > 40)) {
            throw new \InvalidArgumentException('invalid length for $other_names when calling Name., must be smaller than or equal to 40.');
        }
        if (!is_null($other_names) && (mb_strlen($other_names) < 1)) {
            throw new \InvalidArgumentException('invalid length for $other_names when calling Name., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Name., must be smaller than or equal to 40.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Name., must be bigger than or equal to 1.');
        }
