...
/**
 * FundingPayorStatusAuditResponse Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class FundingPayorStatusAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FundingPayorStatusAuditResponse';
    ...
    */
     ...
     * Sets funding_id
     *
     * @param string|null $funding_id funding_id
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FundingPayorStatusAuditResponse., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FundingPayorStatusAuditResponse., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling FundingPayorStatusAuditResponse., must conform to the pattern /^[A-Z]{3}$/.");
        }
