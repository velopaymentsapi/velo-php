...
/**
 * CreatePaymentChannel Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CreatePaymentChannel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentChannel';
    ...
    public function setIban($iban)
    {
        if (!is_null($iban) && (mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannel., must be smaller than or equal to 34.');
        }
        if (!is_null($iban) && (mb_strlen($iban) < 15)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannel., must be bigger than or equal to 15.');
        }
        if (!is_null($iban) && (!preg_match("/^[A-Za-z0-9]+$/", $iban))) {
            throw new \InvalidArgumentException("invalid value for $iban when calling CreatePaymentChannel., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
    ...
    public function setAccountNumber($account_number)
    {
        if (!is_null($account_number) && (mb_strlen($account_number) > 17)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannel., must be smaller than or equal to 17.');
        }
        if (!is_null($account_number) && (mb_strlen($account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannel., must be bigger than or equal to 6.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        if (!is_null($routing_number) && (mb_strlen($routing_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannel., must be smaller than or equal to 9.');
        }
        if (!is_null($routing_number) && (mb_strlen($routing_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannel., must be bigger than or equal to 9.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannel., must be bigger than or equal to 2.');
        }
