...
class PaymentResponseV4 implements ModelInterface, ArrayAccess
{
     ...
     * Sets payor_id
     *
     * @param string $payor_id Deprecated in v2.16. Will be populated with submitting payor ID until removed in a later release.
     *
     * @return $this
     */
     ...
     * Sets inverted_rate
     *
     * @param double|null $inverted_rate inverted_rate
     *
     * @return $this
     */
     ...
     *
     * @param string|null $filename_reference filename_reference
     *
     * @return $this
     */
     ...
     * Sets return_cost
     *
     * @param int|null $return_cost return_cost
     *
     * @return $this
     */
