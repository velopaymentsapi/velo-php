...
class SupportedCountryV2 implements ModelInterface, ArrayAccess
{
    ...
    const ISO_COUNTRY_CODE_FR = 'FR';
    const ISO_COUNTRY_CODE_CA = 'CA';
    const ISO_COUNTRY_CODE_JP = 'JP';
    ...
    public function getIsoCountryCodeAllowableValues()
    {
        return [
            ...
            self::ISO_COUNTRY_CODE_FR,
            self::ISO_COUNTRY_CODE_CA,
            self::ISO_COUNTRY_CODE_JP,
        ];
    }
    ...
    {
        $allowedValues = $this->getIsoCountryCodeAllowableValues();
        if (!is_null($iso_country_code) && !in_array($iso_country_code, $allowedValues, true)) {
