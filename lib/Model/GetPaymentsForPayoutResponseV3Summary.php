 ...
 */
class GetPaymentsForPayoutResponseV3Summary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('failed_payments', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets payout_status
     *
     * @param string|null $payout_status The current status of the payout. One of the following values: ACCEPTED, REJECTED, SUBMITTED, QUOTED, INSTRUCTED, COMPLETED, INCOMPLETE, CONFIRMED, WITHDRAWN
     *
     * @return self
     */
    ...
    {
        if (is_null($failed_payments)) {
            throw new \InvalidArgumentException('non-nullable failed_payments cannot be null');
        }
