...
/**
 * UserDetailsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @description &lt;p&gt;All properties are optional&lt;/p&gt; &lt;p&gt;Only provided properties will be updated&lt;/p&gt; &lt;p&gt;Use null to null out a property that is allowed to be nullable&lt;/p&gt;
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserDetailsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDetailsUpdateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'sms_number' => 'string',
        'mfa_type' => '\VeloPayments\Client\Model\MFAType',
    ...
    */
    ...
    public function setPrimaryContactNumber($primary_contact_number)
    {
        if (is_null($primary_contact_number)) {
            array_push($this->openAPINullablesSetToNull, 'primary_contact_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('primary_contact_number', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($primary_contact_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($primary_contact_number)))) {
            throw new \InvalidArgumentException("invalid value for \$primary_contact_number when calling UserDetailsUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
    ...
    public function setSecondaryContactNumber($secondary_contact_number)
    {
        ...
        if (!is_null($secondary_contact_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($secondary_contact_number)))) {
            throw new \InvalidArgumentException("invalid value for \$secondary_contact_number when calling UserDetailsUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserDetailsUpdateRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserDetailsUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserDetailsUpdateRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserDetailsUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSmsNumber($sms_number)
    {
        if (is_null($sms_number)) {
            array_push($this->openAPINullablesSetToNull, 'sms_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sms_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($sms_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sms_number)))) {
            throw new \InvalidArgumentException("invalid value for \$sms_number when calling UserDetailsUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
     ...
     * Gets mfa_type
     *
     * @return \VeloPayments\Client\Model\MFAType|null
     */
     ...
     * Sets mfa_type
     *
     * @param \VeloPayments\Client\Model\MFAType|null $mfa_type mfa_type
     *
     * @return self
     */
    ...
    {
        if (is_null($mfa_type)) {
            array_push($this->openAPINullablesSetToNull, 'mfa_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('mfa_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setVerificationCode($verification_code)
    {
        ...
        if (!is_null($verification_code) && (mb_strlen($verification_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling UserDetailsUpdateRequest., must be smaller than or equal to 6.');
        }
        if (!is_null($verification_code) && (mb_strlen($verification_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $verification_code when calling UserDetailsUpdateRequest., must be bigger than or equal to 6.');
        }
