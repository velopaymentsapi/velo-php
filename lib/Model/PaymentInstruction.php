...
class PaymentInstruction implements ModelInterface, ArrayAccess
{
     ...
     * Sets amount
     *
     * @param int $amount Amount to send to Payee
     *
     * @return $this
     */
    public function setAmount($amount)
    {
        ...
        if (($amount > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaymentInstruction., must be smaller than or equal to 9223372036854775807.');
        }
        if (($amount < 1)) {
