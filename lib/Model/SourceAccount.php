...
class SourceAccount implements ModelInterface, ArrayAccess
{
    ...
    public function setCurrency($currency)
    {
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SourceAccount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SourceAccount., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", $currency))) {
            throw new \InvalidArgumentException("invalid value for $currency when calling SourceAccount., must conform to the pattern /^[A-Z]{3}$/.");
        }
