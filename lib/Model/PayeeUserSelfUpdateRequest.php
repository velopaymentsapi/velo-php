...
/**
 * PayeeUserSelfUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PayeeUserSelfUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeeUserSelfUpdateRequest';
    ...
    */
    ...
    public function setPrimaryContactNumber($primary_contact_number)
    {
        ...
        if (!is_null($primary_contact_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($primary_contact_number)))) {
            throw new \InvalidArgumentException("invalid value for \$primary_contact_number when calling PayeeUserSelfUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
    ...
    public function setSecondaryContactNumber($secondary_contact_number)
    {
        ...
        if (!is_null($secondary_contact_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($secondary_contact_number)))) {
            throw new \InvalidArgumentException("invalid value for \$secondary_contact_number when calling PayeeUserSelfUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PayeeUserSelfUpdateRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($first_name) && (mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling PayeeUserSelfUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PayeeUserSelfUpdateRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($last_name) && (mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling PayeeUserSelfUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSmsNumber($sms_number)
    {
        ...
        if (!is_null($sms_number) && (!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sms_number)))) {
            throw new \InvalidArgumentException("invalid value for \$sms_number when calling PayeeUserSelfUpdateRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
