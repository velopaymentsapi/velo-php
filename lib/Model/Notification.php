...
class Notification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category' => 'string',
        'event_name' => 'string',
        'source' => '\VeloPayments\Client\Model\NotificationSource'
    ];
    ...
    */
     ...
     * Sets api_version
     *
     * @param string $api_version The API version of the notification schema
     *
     * @return self
     */
     ...
     *
     * @param int $sequence_number This is a payor specific sequence number starting at 1 for the first notification sent
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string $category The category that the notification relates to. One of \"payment\", \"payee\", \"debit\" or \"system\"
     *
     * @return self
     */
     ...
     * Sets event_name
     *
     * @param string $event_name The name of event that led to this notification
     *
     * @return self
     */
     ...
     * Gets source
     *
     * @return \VeloPayments\Client\Model\NotificationSource|null
     */
     ...
     * Sets source
     *
     * @param \VeloPayments\Client\Model\NotificationSource|null $source source
     *
     * @return self
     */
