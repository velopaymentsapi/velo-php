...
/**
 * FundingRequestV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class FundingRequestV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FundingRequestV3';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['funding_account_id'] === null) {
            $invalidProperties[] = "'funding_account_id' can't be null";
        }
     ...
     *
     * @param string $funding_account_id The funding account id
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param int $amount Amount to fund in minor units
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount > 9999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling FundingRequestV3., must be smaller than or equal to 9999999999.');
        }
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling FundingRequestV3., must be bigger than or equal to 1.');
        }
