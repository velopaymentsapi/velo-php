 ...
 */
class CreatePayeeAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets country
     *
     * @param string $country Ideally a 2 letter ISO 3166-1 country code.  But a limited set of additional values will be corrected.  See Java Locale.getISOCountries() and Locale.getDisplayCountry()
     *
     * @return self
     */
