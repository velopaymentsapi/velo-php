...
class AccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'expires_in' => 'int',
        'scope' => 'string',
        'user_info' => '\VeloPayments\Client\Model\UserInfo',
        'entity_ids' => 'string[]'
    ];
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token Bearer token used in headers to access secure endpoints
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token can be used to obtain a new access token
     *
     * @return self
     */
     ...
     * Gets user_info
     *
     * @return \VeloPayments\Client\Model\UserInfo|null
     */
     ...
     * Sets user_info
     *
     * @param \VeloPayments\Client\Model\UserInfo|null $user_info user_info
     *
     * @return self
     */
     ...
     * Sets entity_ids
     *
     * @param string[]|null $entity_ids If the user is a payee then the payeeId<P> If the user is a payor then the payorId
     *
     * @return self
     */
