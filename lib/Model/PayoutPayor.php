 ...
 */
class PayoutPayor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutPayor';
    ...
    */
     ...
     * Sets dba_name
     *
     * @param string $dba_name The alternate name of the payor.
     *
     * @return self
     */
     ...
     * Sets principal
     *
     * @param string $principal Email address if principal is a user or ID if application.
     *
     * @return self
     */
     ...
     * Sets principal_id
     *
     * @param string $principal_id The id of the principal.
     *
     * @return self
     */
