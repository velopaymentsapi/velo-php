...
/**
 * FundingAccountResponse Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FundingAccountResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FundingAccountResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['source_account_ids'] = isset($data['source_account_ids']) ? $data['source_account_ids'] : null;
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FundingAccountResponse., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling FundingAccountResponse., must be bigger than or equal to 3.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling FundingAccountResponse., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling FundingAccountResponse., must be bigger than or equal to 2.');
        }
