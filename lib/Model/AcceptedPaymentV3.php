    ...
    */
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling AcceptedPaymentV3., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling AcceptedPaymentV3., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrencyType($currency_type)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency_type)))) {
     ...
     * Sets amount
     *
     * @param int $amount The amount of the payment in minor units
     *
     * @return self
     */
     ...
     *
     * @param string $source_account_name The identifier of the source account to debit the payment from
     *
     * @return self
     */
     ...
     *
     * @param string $payor_payment_id A reference identifier for the payor for the given payee payment
     *
     * @return self
     */
    public function setPayorPaymentId($payor_payment_id)
    {
        ...
        if ((mb_strlen($payor_payment_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $payor_payment_id when calling AcceptedPaymentV3., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($payor_payment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payor_payment_id when calling AcceptedPaymentV3., must be bigger than or equal to 0.');
        }
    ...
    public function setPaymentMemo($payment_memo)
    {
        ...
        if ((mb_strlen($payment_memo) > 40)) {
            throw new \InvalidArgumentException('invalid length for $payment_memo when calling AcceptedPaymentV3., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($payment_memo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_memo when calling AcceptedPaymentV3., must be bigger than or equal to 0.');
        }
    ...
    public function setRemoteSystemId($remote_system_id)
    {
        ...
        if ((mb_strlen($remote_system_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_system_id when calling AcceptedPaymentV3., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_system_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_system_id when calling AcceptedPaymentV3., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentMetadata($payment_metadata)
    {
        ...
        if ((mb_strlen($payment_metadata) > 512)) {
            throw new \InvalidArgumentException('invalid length for $payment_metadata when calling AcceptedPaymentV3., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($payment_metadata) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_metadata when calling AcceptedPaymentV3., must be bigger than or equal to 0.');
        }
     ...
     * Sets rails_id
     *
     * @param string $rails_id Indicates the 3rd party system involved in making this payment
     *
     * @return self
     */
