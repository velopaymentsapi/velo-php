 ...
 * @link     https://openapi-generator.tech
 */
class PayoutSummaryAuditV4 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_returned_payments'] = isset($data['total_returned_payments']) ? $data['total_returned_payments'] : null;
     ...
     * Sets payor_id
     *
     * @param string|null $payor_id Deprecated in v2.16. Will be populated with submitting payor ID until removed in a later release.
     *
     * @return $this
     */
