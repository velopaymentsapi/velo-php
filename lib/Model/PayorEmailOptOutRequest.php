...
/**
 * PayorEmailOptOutRequest Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayorEmailOptOutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayorEmailOptOutRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reminder_emails_opt_out'] === null) {
            $invalidProperties[] = "'reminder_emails_opt_out' can't be null";
        }
     ...
     *
     * @param bool $reminder_emails_opt_out reminder_emails_opt_out
     *
     * @return self
     */
