...
/**
 * QuoteFxSummary Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class QuoteFxSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuoteFxSummary';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_source_amount'] = isset($data['total_source_amount']) ? $data['total_source_amount'] : null;
     ...
     * Sets inverted_rate
     *
     * @param float|null $inverted_rate inverted_rate
     *
     * @return $this
     */
     ...
     *
     * @param int $total_source_amount total_source_amount
     *
     * @return $this
     */
    ...
    public function setSourceCurrency($source_currency)
    {
        if ((mb_strlen($source_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling QuoteFxSummary., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($source_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling QuoteFxSummary., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", $source_currency))) {
            throw new \InvalidArgumentException("invalid value for $source_currency when calling QuoteFxSummary., must conform to the pattern /^[A-Z]{3}$/.");
        }
    ...
    public function setPaymentCurrency($payment_currency)
    {
        if ((mb_strlen($payment_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling QuoteFxSummary., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($payment_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling QuoteFxSummary., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", $payment_currency))) {
            throw new \InvalidArgumentException("invalid value for $payment_currency when calling QuoteFxSummary., must conform to the pattern /^[A-Z]{3}$/.");
        }
