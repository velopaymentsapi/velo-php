...
/**
 * PayoutScheduleV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutScheduleV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutScheduleV3';
    ...
    */
     ...
     *
     * @param string $schedule_status The current status of the payout schedule. One of the following values: SCHEDULED, EXECUTED, FAILED
     *
     * @return self
     */
