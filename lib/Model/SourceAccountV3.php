...
/**
 * SourceAccountV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class SourceAccountV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceAccountV3';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_payout_cost', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string $source_account_name The name of the source account as referencec in the payout
     *
     * @return self
     */
     ...
     *
     * @param string $source_account_id The id of the payout
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SourceAccountV3., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling SourceAccountV3., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling SourceAccountV3., must conform to the pattern /^[A-Z]{3}$/.");
        }
     ...
     *
     * @param int $total_payout_cost The total amount (in mnor units) that will be debited from the source account for the payout
     *
     * @return self
     */
    public function setTotalPayoutCost($total_payout_cost)
    {
        if (is_null($total_payout_cost)) {
            throw new \InvalidArgumentException('non-nullable total_payout_cost cannot be null');
        }
