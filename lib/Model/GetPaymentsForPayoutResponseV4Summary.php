 ...
 * @link     https://openapi-generator.tech
 */
class GetPaymentsForPayoutResponseV4Summary implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['quoted_date_time'] = isset($data['quoted_date_time']) ? $data['quoted_date_time'] : null;
        ...
        $this->container['returned_payments'] = isset($data['returned_payments']) ? $data['returned_payments'] : null;
        $this->container['withdrawn_payments'] = isset($data['withdrawn_payments']) ? $data['withdrawn_payments'] : null;
        $this->container['payout_type'] = isset($data['payout_type']) ? $data['payout_type'] : null;
        $this->container['submitting'] = isset($data['submitting']) ? $data['submitting'] : null;
        ...
        $this->container['quoted'] = isset($data['quoted']) ? $data['quoted'] : null;
        $this->container['instructed'] = isset($data['instructed']) ? $data['instructed'] : null;
