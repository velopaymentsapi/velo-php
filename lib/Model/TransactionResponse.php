...
class TransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'transaction_short_code' => 'setTransactionShortCode',
        'payor_id' => 'setPayorId',
    ...
    protected static $getters = [
        ...
        'transaction_short_code' => 'getTransactionShortCode',
        'payor_id' => 'getPayorId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transaction_short_code', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transaction_short_code'] === null) {
            $invalidProperties[] = "'transaction_short_code' can't be null";
        }
        if (!is_null($this->container['balance']) && ($this->container['balance'] > 9999999999)) {
            $invalidProperties[] = "invalid value for 'balance', must be smaller than or equal to 9999999999.";
        }
    ...
    /**
     * Gets transaction_short_code
     *
     * @return string
     */
    public function getTransactionShortCode()
    {
        return $this->container['transaction_short_code'];
    }

    /**
     * Sets transaction_short_code
     *
     * @param string $transaction_short_code The short code for the transaction that can be used when sending funds into the platform
     *
     * @return self
     */
    public function setTransactionShortCode($transaction_short_code)
    {
        if (is_null($transaction_short_code)) {
            throw new \InvalidArgumentException('non-nullable transaction_short_code cannot be null');
        }
        $this->container['transaction_short_code'] = $transaction_short_code;
     ...
     * Sets payor_id
     *
     * @param string|null $payor_id Indicates the Payor of the Transaction and which matches the payorId on the provided source account
     *
     * @return self
     */
     ...
     *
     * @param string|null $source_account_name The name of the source account associated with the Transaction
     *
     * @return self
     */
     ...
     *
     * @param string|null $source_account_id The Id of the source account associated with the Transaction
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_reference The payors own reference for the transaction
     *
     * @return self
     */
     ...
     *
     * @param array<string,string>|null $transaction_metadata Optional metadata attached to the transaction at creation time.
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param int|null $balance The total amount of transaction in minor units
     *
     * @return self
     */
    public function setBalance($balance)
    {
        ...
        if (($balance > 9999999999)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling TransactionResponse., must be smaller than or equal to 9999999999.');
        }
        if (($balance < 0)) {
            throw new \InvalidArgumentException('invalid value for $balance when calling TransactionResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling TransactionResponse., must be bigger than or equal to 3.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at A timestamp when the transaction has been created.
     *
     * @return self
     */
