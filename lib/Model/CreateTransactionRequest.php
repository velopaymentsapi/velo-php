...
class CreateTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'transaction_metadata' => 'array<string,string>'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['source_account_name']) > 100)) {
            $invalidProperties[] = "invalid value for 'source_account_name', the character length must be smaller than or equal to 100.";
        }

        if ((mb_strlen($this->container['source_account_name']) < 3)) {
            $invalidProperties[] = "invalid value for 'source_account_name', the character length must be bigger than or equal to 3.";
        }

        if ($this->container['transaction_reference'] === null) {
            $invalidProperties[] = "'transaction_reference' can't be null";
        }
        if ((mb_strlen($this->container['transaction_reference']) > 100)) {
            $invalidProperties[] = "invalid value for 'transaction_reference', the character length must be smaller than or equal to 100.";
        }

        if ((mb_strlen($this->container['transaction_reference']) < 6)) {
            $invalidProperties[] = "invalid value for 'transaction_reference', the character length must be bigger than or equal to 6.";
        }
     ...
     * Sets payor_id
     *
     * @param string $payor_id Indicates the Payor creating the Transaction and which matches the payorId on the provided source account
     *
     * @return self
     */
     ...
     *
     * @param string $source_account_name The name of the source account that the new Transaction will be associated with and any funding containing the transactionShortCode will credit.
     *
     * @return self
     */
    public function setSourceAccountName($source_account_name)
    {
        ...
        if ((mb_strlen($source_account_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $source_account_name when calling CreateTransactionRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($source_account_name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $source_account_name when calling CreateTransactionRequest., must be bigger than or equal to 3.');
        }
     ...
     *
     * @param string $transaction_reference The payors own reference for the transaction that can later be used for querying and retrieval.
     *
     * @return self
     */
    public function setTransactionReference($transaction_reference)
    {
        ...
        if ((mb_strlen($transaction_reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $transaction_reference when calling CreateTransactionRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($transaction_reference) < 6)) {
            throw new \InvalidArgumentException('invalid length for $transaction_reference when calling CreateTransactionRequest., must be bigger than or equal to 6.');
        }
     ...
     *
     * @param array<string,string>|null $transaction_metadata Optional metadata that will be attached to the created transaction and can that can be retrieved later.| The total length of all the keys and values provided in the metadata must be no more than 4000 chars.
     *
     * @return self
     */
