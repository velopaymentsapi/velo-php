...
/**
 * PayeeDeltaV4 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayeeDeltaV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeeDeltaV4';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payee_country']) && (mb_strlen($this->container['payee_country']) > 2)) {
            $invalidProperties[] = "invalid value for 'payee_country', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['payee_country']) && (mb_strlen($this->container['payee_country']) < 2)) {
            $invalidProperties[] = "invalid value for 'payee_country', the character length must be bigger than or equal to 2.";
        }

        if (!is_null($this->container['payee_country']) && !preg_match("/^[A-Z]{2}$/", $this->container['payee_country'])) {
            $invalidProperties[] = "invalid value for 'payee_country', must be conform to the pattern /^[A-Z]{2}$/.";
        }
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling PayeeDeltaV4., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling PayeeDeltaV4., must be bigger than or equal to 1.');
        }
     ...
     * Sets payee_country
     *
     * @param string|null $payee_country Valid ISO 3166 2 character country code. See the <a href=\"https://www.iso.org/iso-3166-country-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
     *
     * @return self
     */
    public function setPayeeCountry($payee_country)
    {
        ...
        if ((mb_strlen($payee_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $payee_country when calling PayeeDeltaV4., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($payee_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $payee_country when calling PayeeDeltaV4., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($payee_country)))) {
            throw new \InvalidArgumentException("invalid value for \$payee_country when calling PayeeDeltaV4., must conform to the pattern /^[A-Z]{2}$/.");
        }
     ...
     *
     * @param string|null $onboarded_status Payee onboarded status. One of the following value: CREATED, INVITED, REGISTERED, ONBOARDED
     *
     * @return self
     */
