...
/**
 * UpdateRemoteIdRequestV4 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateRemoteIdRequestV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateRemoteIdRequestV4';
    ...
    */
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling UpdateRemoteIdRequestV4., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling UpdateRemoteIdRequestV4., must be bigger than or equal to 1.');
        }
