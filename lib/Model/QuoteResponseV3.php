...
/**
 * QuoteResponseV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class QuoteResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuoteResponseV3';
    ...
    */
     ...
     * Gets fx_summaries
     *
     * @return \VeloPayments\Client\Model\QuoteFxSummaryV3[]|null
     */
     ...
     * Sets fx_summaries
     *
     * @param \VeloPayments\Client\Model\QuoteFxSummaryV3[]|null $fx_summaries fx_summaries
     *
     * @return self
     */
