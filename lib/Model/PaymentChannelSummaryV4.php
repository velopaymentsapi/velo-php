...
/**
 * PaymentChannelSummaryV4 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentChannelSummaryV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentChannelSummaryV4';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_channel_id'] === null) {
            $invalidProperties[] = "'payment_channel_id' can't be null";
        }
     ...
     *
     * @param string $payment_channel_id payment_channel_id
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The payment channel name
     *
     * @return self
     */
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PaymentChannelSummaryV4., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PaymentChannelSummaryV4., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling PaymentChannelSummaryV4., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentChannelSummaryV4., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentChannelSummaryV4., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling PaymentChannelSummaryV4., must conform to the pattern /^[A-Z]{3}$/.");
        }
     ...
     * Sets last4_digits
     *
     * @param string|null $last4_digits The last 4 digits of the account number or IBAN
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled Usually true. False if an associated payment is returned
     *
     * @return self
     */
     ...
     *
     * @param string|null $disabled_reason Indicates why the payment channel was disabled
     *
     * @return self
     */
