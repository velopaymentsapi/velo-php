...
/**
 * RejectedPaymentV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class RejectedPaymentV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RejectedPaymentV3';
    ...
    */
     ...
     * Sets remote_id
     *
     * @param string $remote_id The remoteId supplied by the payor that identifies the payee
     *
     * @return self
     */
    ...
    public function setCurrencyType($currency_type)
    {
        ...
        if ((mb_strlen($currency_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_type when calling RejectedPaymentV3., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_type) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_type when calling RejectedPaymentV3., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency_type)))) {
            throw new \InvalidArgumentException("invalid value for \$currency_type when calling RejectedPaymentV3., must conform to the pattern /^[A-Z]{3}$/.");
        }
    ...
    public function setPayorPaymentId($payor_payment_id)
    {
        ...
        if ((mb_strlen($payor_payment_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $payor_payment_id when calling RejectedPaymentV3., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($payor_payment_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payor_payment_id when calling RejectedPaymentV3., must be bigger than or equal to 0.');
        }
    ...
    public function setRemoteSystemId($remote_system_id)
    {
        ...
        if ((mb_strlen($remote_system_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_system_id when calling RejectedPaymentV3., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_system_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_system_id when calling RejectedPaymentV3., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentMetadata($payment_metadata)
    {
        ...
        if ((mb_strlen($payment_metadata) > 512)) {
            throw new \InvalidArgumentException('invalid length for $payment_metadata when calling RejectedPaymentV3., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($payment_metadata) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payment_metadata when calling RejectedPaymentV3., must be bigger than or equal to 0.');
        }
     ...
     * Sets reason
     *
     * @param string $reason The reason for the payment being rejected
     *
     * @return self
     */
     ...
     * Sets reason_code
     *
     * @param string|null $reason_code The reason code as determined by Velo
     *
     * @return self
     */
     ...
     * Sets line_number
     *
     * @param int|null $line_number If the payment was submitted in a csv payout then this will be the line number of the payment in the file
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A more general rejection message than the reason property
     *
     * @return self
     */
