...
/**
 * CreatePaymentChannelRequestV4 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentChannelRequestV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentChannelRequestV4';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payment_channel_name']) && (mb_strlen($this->container['payment_channel_name']) > 30)) {
            $invalidProperties[] = "invalid value for 'payment_channel_name', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['payment_channel_name']) && (mb_strlen($this->container['payment_channel_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'payment_channel_name', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setPaymentChannelName($payment_channel_name)
    {
        ...
        if ((mb_strlen($payment_channel_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_name when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($payment_channel_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_channel_name when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 1.');
        }
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($iban) < 15)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 15.');
        }
        if ((!preg_match("/^[A-Za-z0-9]+$/", ObjectSerializer::toString($iban)))) {
            throw new \InvalidArgumentException("invalid value for \$iban when calling CreatePaymentChannelRequestV4., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 256)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($account_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 1.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 256)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($routing_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string|null $country_code Valid ISO 3166 2 character country code. See the <a href=\"https://www.iso.org/iso-3166-country-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling CreatePaymentChannelRequestV4., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentChannelRequestV4., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentChannelRequestV4., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CreatePaymentChannelRequestV4., must conform to the pattern /^[A-Z]{3}$/.");
        }
