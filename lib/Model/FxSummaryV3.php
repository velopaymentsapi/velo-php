 ...
 */
class FxSummaryV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSourceCurrency($source_currency)
    {
        ...
        if ((mb_strlen($source_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling FxSummaryV3., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($source_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling FxSummaryV3., must be bigger than or equal to 3.');
        }
    ...
    public function setPaymentCurrency($payment_currency)
    {
        ...
        if ((mb_strlen($payment_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling FxSummaryV3., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($payment_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling FxSummaryV3., must be bigger than or equal to 3.');
        }
