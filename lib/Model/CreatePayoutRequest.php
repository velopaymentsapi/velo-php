...
class CreatePayoutRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'payor_id' => 'string',
        'payout_memo' => 'string',
        'payments' => '\OpenAPI\Client\Model\PaymentInstruction[]'
    ];
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\Model\PaymentInstruction[]
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\PaymentInstruction[] $payments payments
     *
     * @return $this
     */
