 ...
 */
class Payee2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payee_2';
    ...
    protected static $openAPITypes = [
        ...
        'country' => 'string',
        'display_name' => 'string',
        'payment_channel' => '\VeloPayments\Client\Model\PayeePaymentChannel2',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['remote_id']) && (mb_strlen($this->container['remote_id']) > 100)) {
            $invalidProperties[] = "invalid value for 'remote_id', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['remote_id']) && (mb_strlen($this->container['remote_id']) < 1)) {
     ...
     *
     * @return \VeloPayments\Client\Model\PayeePaymentChannel2|null
     */
     ...
     *
     * @param \VeloPayments\Client\Model\PayeePaymentChannel2|null $payment_channel payment_channel
     *
     * @return self
     */
     ...
     * Sets remote_id
     *
     * @param string|null $remote_id Remote Id must be between 1 and 100 characters long
     *
     * @return self
     */
    public function setRemoteId($remote_id)
    {
        if (!is_null($remote_id) && (mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling Payee2., must be smaller than or equal to 100.');
        }
        if (!is_null($remote_id) && (mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling Payee2., must be bigger than or equal to 1.');
        }
