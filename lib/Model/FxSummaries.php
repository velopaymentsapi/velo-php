 ...
 * @link     https://openapi-generator.tech
 */
class FxSummaries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FxSummaries';
     ...
     * Sets total_cost
     *
     * @param object $total_cost total_cost
     *
     * @return $this
     */
     ...
     *
     * @param object $total_payment_amount total_payment_amount
     *
     * @return $this
     */
    ...
    public function setSourceCurrency($source_currency)
    {
        if ((mb_strlen($source_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling FxSummaries., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($source_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $source_currency when calling FxSummaries., must be bigger than or equal to 3.');
        }
    ...
    public function setPaymentCurrency($payment_currency)
    {
        if ((mb_strlen($payment_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling FxSummaries., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($payment_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $payment_currency when calling FxSummaries., must be bigger than or equal to 3.');
        }
