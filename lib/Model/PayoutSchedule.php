...
/**
 * PayoutSchedule Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayoutSchedule';
    ...
    protected static $openAPIFormats = [
        ...
        'scheduled_by_principal_id' => null,
    ...
    protected static array $openAPINullables = [
		...
		'scheduled_at' => false,
		'scheduled_for' => false,
		'scheduled_by_principal_id' => false,
    ...
    protected static $setters = [
        ...
        'scheduled_by_principal_id' => 'setScheduledByPrincipalId',
    ...
    protected static $getters = [
        ...
        'scheduled_by_principal_id' => 'getScheduledByPrincipalId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scheduled_by_principal_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scheduled_by_principal_id'] === null) {
            $invalidProperties[] = "'scheduled_by_principal_id' can't be null";
        }
     ...
     *
     * @param string $schedule_status Current status of the payout schedule. One of the following values: SCHEDULED, EXECUTED, FAILED
     *
     * @return self
     */
    ...
    /**
     * Gets scheduled_by_principal_id
     *
     * @return string
     */
    public function getScheduledByPrincipalId()
    {
        return $this->container['scheduled_by_principal_id'];
    }

    /**
     * Sets scheduled_by_principal_id
     *
     * @param string $scheduled_by_principal_id ID of the user or application that scheduled the payout
     *
     * @return self
     */
    public function setScheduledByPrincipalId($scheduled_by_principal_id)
    {
        if (is_null($scheduled_by_principal_id)) {
            throw new \InvalidArgumentException('non-nullable scheduled_by_principal_id cannot be null');
        }
        $this->container['scheduled_by_principal_id'] = $scheduled_by_principal_id;
     ...
     * Sets scheduled_by
     *
     * @param string|null $scheduled_by Optional display name as a hint for who scheduled the payout. Not populated if payout was scheduled by an application.
     *
     * @return self
     */
