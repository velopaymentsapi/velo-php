...
/**
 * CreatePayeeV4 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePayeeV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePayeeV4';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeeV4., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeeV4., must be bigger than or equal to 3.');
        }
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeeV4., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeeV4., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \VeloPayments\Client\Model\CreatePayeeAddressV4
     */
     ...
     * Sets address
     *
     * @param \VeloPayments\Client\Model\CreatePayeeAddressV4 $address address
     *
     * @return self
     */
