...
/**
 * SchedulePayoutRequestV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class SchedulePayoutRequestV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SchedulePayoutRequestV3';
    ...
    */
     ...
     * Sets scheduled_for
     *
     * @param \DateTime $scheduled_for UTC timestamp for instructing the payout. Format is ISO-8601.
     *
     * @return self
     */
     ...
     *
     * @param bool $notifications_enabled Flag to indicate whether to receive notifications when scheduled payout is processed
     *
     * @return self
     */
