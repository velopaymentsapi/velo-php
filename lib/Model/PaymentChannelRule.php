...
/**
 * PaymentChannelRule Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentChannelRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentChannelRule';
    ...
    */
     ...
     * Sets element
     *
     * @param string $element <p>the rule element</p> <p>will match a given element name for a payment channel configuration
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool $required is this element required
     *
     * @return self
     */
     ...
     * Sets min_length
     *
     * @param int|null $min_length mininum length of the element data
     *
     * @return self
     */
     ...
     * Sets max_length
     *
     * @param int|null $max_length maximum length of the element data
     *
     * @return self
     */
     ...
     * Sets validation
     *
     * @param string $validation a regex to validate the element data
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description An optional description, or hint, as to how the user should enter the field value.
     *
     * @return self
     */
