...
/**
 * QueryBatchResponseV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class QueryBatchResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryBatchResponseV3';
    ...
    protected static $openAPITypes = [
        ...
        'failure_count' => 'int',
        'pending_count' => 'int',
        'failures' => '\VeloPayments\Client\Model\FailedSubmissionV3[]'
    ];
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Batch Status. One of the following values: SUBMITTED, ACCEPTED
     *
     * @return self
     */
     ...
     * Gets failures
     *
     * @return \VeloPayments\Client\Model\FailedSubmissionV3[]|null
     */
     ...
     * Sets failures
     *
     * @param \VeloPayments\Client\Model\FailedSubmissionV3[]|null $failures failures
     *
     * @return self
     */
