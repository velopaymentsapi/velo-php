...
/**
 * CreatePaymentChannelV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePaymentChannelV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentChannelV3';
    ...
    */
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 34)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannelV3., must be smaller than or equal to 34.');
        }
        if ((mb_strlen($iban) < 15)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling CreatePaymentChannelV3., must be bigger than or equal to 15.');
        }
        if ((!preg_match("/^[A-Za-z0-9]+$/", ObjectSerializer::toString($iban)))) {
            throw new \InvalidArgumentException("invalid value for \$iban when calling CreatePaymentChannelV3., must conform to the pattern /^[A-Za-z0-9]+$/.");
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 17)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannelV3., must be smaller than or equal to 17.');
        }
        if ((mb_strlen($account_number) < 6)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CreatePaymentChannelV3., must be bigger than or equal to 6.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannelV3., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($routing_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling CreatePaymentChannelV3., must be bigger than or equal to 9.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannelV3., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreatePaymentChannelV3., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($country_code)))) {
            throw new \InvalidArgumentException("invalid value for \$country_code when calling CreatePaymentChannelV3., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentChannelV3., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreatePaymentChannelV3., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CreatePaymentChannelV3., must conform to the pattern /^[A-Z]{3}$/.");
        }
