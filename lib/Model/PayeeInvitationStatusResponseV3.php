...
/**
 * PayeeInvitationStatusResponseV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayeeInvitationStatusResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeeInvitationStatusResponseV3';
    ...
    */
     ...
     *
     * @param string $invitation_status Payee invitation status. One of the following values: ACCEPTED, PENDING, DECLINED
     *
     * @return self
     */
    ...
    public function setGracePeriodEndDate($grace_period_end_date)
    {
        if (is_null($grace_period_end_date)) {
            throw new \InvalidArgumentException('non-nullable grace_period_end_date cannot be null');
        }
