...
/**
 * CommonLinkObject Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CommonLinkObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommonLinkObject';
    ...
    */
     ...
     * Sets rel
     *
     * @param string|null $rel One of: first, last, or self
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string|null $href the resource URI
     *
     * @return self
     */
