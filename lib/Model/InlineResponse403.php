...
class InlineResponse403 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'errors' => '\VeloPayments\Client\Model\Error[]',
    ...
    */
     ...
     * Gets errors
     *
     * @return \VeloPayments\Client\Model\Error[]|null
     */
     ...
     * Sets errors
     *
     * @param \VeloPayments\Client\Model\Error[]|null $errors one or more errors
     *
     * @return self
     */
    public function setErrors($errors)
    {
        ...
        if (!is_null($errors) && (count($errors) < 1)) {
            throw new \InvalidArgumentException('invalid length for $errors when calling InlineResponse403., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id a unique identifier to track a request or related sequence of requests
     *
     * @return self
     */
     ...
     *
     * @param int|null $http_status_code this will mirror the Status-Code part of the Status-Line http response header and is included for extra clarity
     *
     * @return self
     */
