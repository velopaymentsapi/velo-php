...
class PayorV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'funding_account_routing_number' => false,
		'funding_account_account_number' => false,
		'funding_account_account_name' => false,
		'kyc_state' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('funding_account_routing_number', $data ?? [], null);
        $this->setIfExists('funding_account_account_number', $data ?? [], null);
        $this->setIfExists('funding_account_account_name', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($funding_account_routing_number)) {
            throw new \InvalidArgumentException('non-nullable funding_account_routing_number cannot be null');
        }
    ...
    {
        if (is_null($funding_account_account_number)) {
            throw new \InvalidArgumentException('non-nullable funding_account_account_number cannot be null');
        }
    ...
    {
        if (is_null($funding_account_account_name)) {
            throw new \InvalidArgumentException('non-nullable funding_account_account_name cannot be null');
        }
