...
/**
 * CreatePayeeV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePayeeV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePayeeV3';
    ...
    protected static $openAPITypes = [
        ...
        'remote_id' => 'string',
        'type' => 'string',
        'address' => '\VeloPayments\Client\Model\CreatePayeeAddressV3',
        'payment_channel' => '\VeloPayments\Client\Model\CreatePaymentChannelV3',
        'challenge' => '\VeloPayments\Client\Model\ChallengeV3',
        'language' => 'string',
        'company' => '\VeloPayments\Client\Model\CompanyV3',
        'individual' => '\VeloPayments\Client\Model\CreateIndividualV3'
    ];
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeeV3., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreatePayeeV3., must be bigger than or equal to 3.');
        }
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeeV3., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling CreatePayeeV3., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string $type Type of Payee. One of the following values: Individual, Company
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \VeloPayments\Client\Model\CreatePayeeAddressV3
     */
     ...
     * Sets address
     *
     * @param \VeloPayments\Client\Model\CreatePayeeAddressV3 $address address
     *
     * @return self
     */
     ...
     *
     * @return \VeloPayments\Client\Model\CreatePaymentChannelV3|null
     */
     ...
     *
     * @param \VeloPayments\Client\Model\CreatePaymentChannelV3|null $payment_channel payment_channel
     *
     * @return self
     */
     ...
     * Gets individual
     *
     * @return \VeloPayments\Client\Model\CreateIndividualV3|null
     */
     ...
     * Sets individual
     *
     * @param \VeloPayments\Client\Model\CreateIndividualV3|null $individual individual
     *
     * @return self
     */
