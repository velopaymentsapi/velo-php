...
/**
 * PayorLinksResponsePayors Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayorLinksResponsePayors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayorLinksResponse_payors';
    ...
    */
     ...
     * Sets kyc_state
     *
     * @param string|null $kyc_state Current KYC state. One of the following values: FAILED_KYC, PASSED_KYC, REQUIRES_KYC
     *
     * @return self
     */
