...
/**
 * PayeeDeltaV3 Class Doc Comment
 *
 * @category Class
 * @package  VeloPayments\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayeeDeltaV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayeeDeltaV3';
    ...
    */
    ...
    public function setRemoteId($remote_id)
    {
        ...
        if ((mb_strlen($remote_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling PayeeDeltaV3., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($remote_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $remote_id when calling PayeeDeltaV3., must be bigger than or equal to 1.');
        }
     ...
     * Sets payee_country
     *
     * @param string|null $payee_country payee_country
     *
     * @return self
     */
