...
> \VeloPayments\Client\Model\PayorLinksResponse payorLinks($descendants_of_payor, $fields)
...
try {
    $result = $apiInstance->payorLinks($descendants_of_payor, $fields);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **descendants_of_payor** | [**string**](../Model/.md)| The Payor ID from which to start the query to show all descendants |
