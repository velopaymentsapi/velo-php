...
```php
getPayeesInvitationStatusV1($payor_id): \VeloPayments\Client\Model\InvitationStatusResponse
```
...
try {
    ...
    echo 'Exception when calling PayeeInvitationApi->getPayeesInvitationStatusV1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPayeesInvitationStatusV2($payor_id, $payee_id, $invitation_status, $page, $page_size): \VeloPayments\Client\Model\PagedPayeeInvitationStatusResponse
```
...
try {
    ...
    echo 'Exception when calling PayeeInvitationApi->getPayeesInvitationStatusV2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getPayeesInvitationStatusV3($payor_id, $payee_id, $invitation_status, $page, $page_size): \VeloPayments\Client\Model\PagedPayeeInvitationStatusResponse2
```
...
```php
queryBatchStatusV2($batch_id): \VeloPayments\Client\Model\QueryBatchResponse
```
...
try {
    $result = $apiInstance->queryBatchStatusV2($batch_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PayeeInvitationApi->queryBatchStatusV2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
queryBatchStatusV3($batch_id): \VeloPayments\Client\Model\QueryBatchResponse2
```
...
```php
resendPayeeInviteV1($payee_id, $invite_payee_request)
```
...
try {
    $apiInstance->resendPayeeInviteV1($payee_id, $invite_payee_request);
} catch (Exception $e) {
    echo 'Exception when calling PayeeInvitationApi->resendPayeeInviteV1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
resendPayeeInviteV3($payee_id, $invite_payee_request2)
```
...
try {
    $apiInstance->resendPayeeInviteV3($payee_id, $invite_payee_request2);
} catch (Exception $e) {
...
```php
v2CreatePayee($create_payees_request): \VeloPayments\Client\Model\CreatePayeesCSVResponse
```
...
```php
v3CreatePayee($create_payees_request2): \VeloPayments\Client\Model\CreatePayeesCSVResponse2
```
...
try {
    $result = $apiInstance->v3CreatePayee($create_payees_request2);
    print_r($result);
} catch (Exception $e) {
