...
$invitation_status = new \VeloPayments\Client\Model\\VeloPayments\Client\Model\InvitationStatusV4(); // \VeloPayments\Client\Model\InvitationStatusV4 | The invitation status of the payees.
 ...
 **invitation_status** | [**\VeloPayments\Client\Model\InvitationStatusV4**](../Model/.md)| The invitation status of the payees. | [optional]
